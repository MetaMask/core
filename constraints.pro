...
% All non-root packages must have the same "git-since-latest-release" script.
gen_enforced_field(WorkspaceCwd, 'scripts.git-since-latest-release', '../../scripts/git-since-latest-release.sh') :-
  WorkspaceCwd \= '.'.

gen_enforced_field(WorkspaceCwd, 'scripts.since-latest-release', null).

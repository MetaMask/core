...
import MMIController from './MMIController';
import * as TransactionController from '../../transaction-controller/src';
import * as PreferencesController from '../../preferences-controller/src';

describe('MMIController', function () {
  let mmiController: any;

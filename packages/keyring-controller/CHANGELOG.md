...
- feat: add `KeyringController:addNewAccount` messenger action ([#4565](https://github.com/MetaMask/core.git/pull/4565))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/keyring-controller@17.1.2...HEAD

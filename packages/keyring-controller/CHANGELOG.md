...
- fix: add wildcard for custody keyring ([#3899](https://github.com/MetaMask/core.git/pull/3899))
- Merge `EthKeyringController` into `KeyringController` ([#3830](https://github.com/MetaMask/core.git/pull/3830))
- Use Prettier to format changelogs ([#3850](https://github.com/MetaMask/core.git/pull/3850))
- Add tests for KeyringController edge cases ([#3847](https://github.com/MetaMask/core.git/pull/3847))
- Refactor user operations tests ([#3832](https://github.com/MetaMask/core.git/pull/3832))
- Add coverage for unsupported keyring methods ([#3831](https://github.com/MetaMask/core.git/pull/3831))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/keyring-controller@12.2.0...HEAD

...
- fix: lock `KeyringController` mutex on `verifySeedPhrase` ([#5077](https://github.com/MetaMask/core.git/pull/5077))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/keyring-controller@19.0.2...HEAD

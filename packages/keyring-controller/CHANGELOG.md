...
- refactor(keyring-controller): ensure authorization contract address is provided ([#5353](https://github.com/MetaMask/core.git/pull/5353))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/keyring-controller@19.2.0...HEAD

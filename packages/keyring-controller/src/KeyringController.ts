...
const simpleKeyringV2Builder: KeyringV2Builder = Object.assign(
  (keyring: Keyring): KeyringV2 =>
    new SimpleKeyringV2({
      ...
      // which still depends on `@metamask/utils@^11`, while this repo now uses the
      // workspace copy at v12. That leaves two distinct identities for the same
      // type, so the cast no longer overlaps. Remove this once the keyring
      // packages depend on v12.

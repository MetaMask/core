 ...
 */
function assertCacheEncryptionKeyEnabled(
...
> {
  ...
  async #updateEncryptedEncryptionKey(
    ...
    if (encryptionKey) {
      assertCacheEncryptionKeyEnabled(this.#cacheEncryptionKey);
      ...
      if (this.#cacheEncryptionKey) {
        ...
        if (password) {
          if (encryptedEncryptionKey) {
            ...
            vault = await this.#encryptor.decryptWithKey(key, encryptedVault);
            this.#password = password;

...
- Add `XlmAccountProvider` for Stellar (XLM) snap-backed accounts, including `XLM_ACCOUNT_PROVIDER_DEFAULT_CONFIG` and package export ([#TODO](https://github.com/MetaMask/core/pull/TODO))

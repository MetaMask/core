...
- Bump `@metamask/account-api` from `^1.0.0` to `^1.0.3` ([#8464](https://github.com/MetaMask/core/pull/8464))
...
- Add `MultichainAccountService:ensureCanUseSnapPlatform` method and action. ([#7266](https://github.com/MetaMask/core/pull/7266))
...
- **BREAKING** Add additional allowed actions to the `MultichainAccountService` messenger ([#6478](https://github.com/MetaMask/core/pull/6478))
...
- **BREAKING** Add additional allowed actions to the `MultichainAccountService` messenger ([#6397](https://github.com/MetaMask/core/pull/6397))

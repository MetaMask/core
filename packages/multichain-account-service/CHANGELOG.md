...
- Limit Bitcoin and Tron providers to 3 conccurent account creations by default when creating multichain account groups ([#7052](https://github.com/MetaMask/core/pull/7052))

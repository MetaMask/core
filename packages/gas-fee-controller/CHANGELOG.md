...
- chore(gas-fee-controller): replace `Sinon` with `Jest` fake timers ([#7968](https://github.com/MetaMask/core/pull/7968))
...
- Update changelog for `@metamask/gas-fee-controller@6` ([#1405](https://github.com/MetaMask/core/pull/1405))
...
- [GasFeeController] Add tests for gas-util calculateTimeEstimate function ([#1090](https://github.com/MetaMask/core/pull/1090))
- rename network controller properties state property ([#1074](https://github.com/MetaMask/core/pull/1074))

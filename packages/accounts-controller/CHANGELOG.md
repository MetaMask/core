...
- disable ESLint max-depth rule and TypeScript checking when assigning internal accounts to state due to nested object structure requirements ([#6344](https://github.com/MetaMask/core/pull/6344))

...
- **BREAKING:** Bump accounts related packages ([#6560](https://github.com/MetaMask/core/pull/6560))
  - The `BtcMethod` enum has been updated with new methods and no longer support `SendBitcoin` method.
  - Bump `@metamask/keyring-api` from `^20.1.0` to `^21.0.0`
  - Bump `@metamask/keyring-internal-api` from `^8.1.0` to `^9.0.0`
  - Bump `@metamask/eth-snap-keyring` from `^16.1.0` to `^17.0.0`

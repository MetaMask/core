...
- test(accounts-controller): remove duplicated test mock function ([#5387](https://github.com/MetaMask/core.git/pull/5387))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/accounts-controller@24.0.1...HEAD

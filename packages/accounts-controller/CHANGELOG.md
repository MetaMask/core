...
- fix: add wildcard for custody keyring ([#3899](https://github.com/MetaMask/controllers/pull/3899))
...
[Unreleased]: https://github.com/MetaMask/controllers/compare/@metamask/accounts-controller@10.0.0...HEAD

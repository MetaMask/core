...
- refactor(accounts-controller): use type-cast instead of `@ts-expect-error` ([#5568](https://github.com/MetaMask/core.git/pull/5568))
- Release 347.0.0 ([#5583](https://github.com/MetaMask/core.git/pull/5583))
- fix(accounts-controller): do not fire events during `update` blocks ([#5555](https://github.com/MetaMask/core.git/pull/5555))

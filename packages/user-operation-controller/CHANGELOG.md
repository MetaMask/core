...
- **BREAKING:** Bump `@metamask/transaction-controller` peer dependency from `^45.1.0` to `^46.0.0` ([#5318](https://github.com/MetaMask/core/pull/5318))
- **BREAKING:** Bump `@metamask/gas-fee-controller` peer dependency from `^22.0.0` to `^23.0.0` ([#5318](https://github.com/MetaMask/core/pull/5318))

...
- Release 137.0.0 ([#4159](https://github.com/MetaMask/controllers/pull/4159))
...
- Release 135.0.0 ([#4140](https://github.com/MetaMask/controllers/pull/4140))
- feat: allow gas limits to be changed during #addPaymasterData ([#3942](https://github.com/MetaMask/controllers/pull/3942))
- Release 134.0.0 ([#4131](https://github.com/MetaMask/controllers/pull/4131))
...
[Unreleased]: https://github.com/MetaMask/controllers/compare/@metamask/user-operation-controller@7.0.0...HEAD
[7.0.0]: https://github.com/MetaMask/controllers/compare/@metamask/user-operation-controller@6.0.2...@metamask/user-operation-controller@7.0.0
[6.0.2]: https://github.com/MetaMask/controllers/compare/@metamask/user-operation-controller@6.0.1...@metamask/user-operation-controller@6.0.2
[6.0.1]: https://github.com/MetaMask/controllers/compare/@metamask/user-operation-controller@6.0.0...@metamask/user-operation-controller@6.0.1
[6.0.0]: https://github.com/MetaMask/controllers/compare/@metamask/user-operation-controller@5.0.0...@metamask/user-operation-controller@6.0.0
[5.0.0]: https://github.com/MetaMask/controllers/compare/@metamask/user-operation-controller@4.0.0...@metamask/user-operation-controller@5.0.0
[4.0.0]: https://github.com/MetaMask/controllers/compare/@metamask/user-operation-controller@3.0.0...@metamask/user-operation-controller@4.0.0
[3.0.0]: https://github.com/MetaMask/controllers/compare/@metamask/user-operation-controller@2.0.0...@metamask/user-operation-controller@3.0.0
[2.0.0]: https://github.com/MetaMask/controllers/compare/@metamask/user-operation-controller@1.0.0...@metamask/user-operation-controller@2.0.0
[1.0.0]: https://github.com/MetaMask/controllers/releases/tag/@metamask/user-operation-controller@1.0.0

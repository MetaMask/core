...
- **BREAKING:** Bump `@metamask/transaction-controller` peer dependency to `^55.0.0` ([#TODO](https://github.com/MetaMask/core/pull/TODO))
...
[33.0.0]: https://github.com/MetaMask/core/compare/@metamask/user-operation-controller@33.0.0...@metamask/user-operation-controller@34.0.0

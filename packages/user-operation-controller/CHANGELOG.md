...
- Release 257.0.0 ([#4976](https://github.com/MetaMask/core.git/pull/4976))
- Revert "Release `257.0.0` (#4969)" ([#4969](https://github.com/MetaMask/core.git/pull/4969))
- Release `257.0.0` ([#4969](https://github.com/MetaMask/core.git/pull/4969))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/user-operation-controller@19.0.0...HEAD

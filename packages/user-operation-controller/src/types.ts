...
export type UserOperationMetadata = {
  /** The URL of the bundler that the operation was submitted to. */
  ...
  /** The hash of the user operation, generated by the bundler. */
  hash: string | null;

  /** A unique ID used to identify a user operation in the client. */
  id: string;

  /** The current status of the user operation. */
  status: UserOperationStatus;

  /** The timestamp of when the user operation was created. */
  time: number;

  /** The resulting user operation object to be submitted to the bundler. */

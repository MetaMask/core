  ...
  describe('validateAddUserOperationOptions', () => {
    it.each([
      ...
      [
        ...
        'wrong type',
        123,
        'Expected one of `"cancel","contractInteraction","contractDeployment","eth_decrypt","eth_getEncryptionPublicKey","incoming","personal_sign","retry","simpleSend","eth_signTypedData","smart","bridge","bridgeApproval","swap","swapAndSend","swapApproval","approve","safetransferfrom","transfer","transferfrom","setapprovalforall","increaseAllowance"`, but received: 123',
      ],
    ])(
      'throws if %s is %s',
      (propertyName, _valueDecription, value, expectedError) => {

...
- Remove unused `sinon` `devDependency` from 4 packages ([#7915](https://github.com/MetaMask/core/pull/7915))
...
- Upgrade Jest-related packages to latest 27.x versions ([#7792](https://github.com/MetaMask/core/pull/7792))
- Update ESLint config packages to v15 ([#7305](https://github.com/MetaMask/core/pull/7305))
- Update `typescript` to v5.3 ([#7081](https://github.com/MetaMask/core/pull/7081))

### Fixed

- Auto-fixable ESLint warnings ([#7105](https://github.com/MetaMask/core/pull/7105))
- Build script not working because of missing `@ts-bridge/cli` dependency ([#7040](https://github.com/MetaMask/core/pull/7040))
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/approval-controller@8.0.1...HEAD
[8.0.1]: https://github.com/MetaMask/core/compare/@metamask/approval-controller@8.0.0...@metamask/approval-controller@8.0.1

...
- chore: sends transaction update events ([#5587](https://github.com/MetaMask/core.git/pull/5587))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/multichain-transactions-controller@0.8.0...HEAD

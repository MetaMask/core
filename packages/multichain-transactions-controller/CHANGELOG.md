...
- **BREAKING:** Bump `@metamask/accounts-controller` peer dependency to `^26.0.0` ([#1234](https://github.com/MetaMask/core/pull/1234))
...
[1.0.0]: https://github.com/MetaMask/core/compare/@metamask/multichain-transactions-controller@0.6.0...@metamask/multichain-transactions-controller@1.0.0

...
- feat: remove updateIdentities and make syncIdentities private in preferences controller ([#3976](https://github.com/MetaMask/controllers/pull/3976))
- fix(preferences-controller): skip sync when locking ([#3946](https://github.com/MetaMask/controllers/pull/3946))
...
[Unreleased]: https://github.com/MetaMask/controllers/compare/@metamask/preferences-controller@7.0.0...HEAD

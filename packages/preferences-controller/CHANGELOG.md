...
- fix: Add useMultiRpcMigration to PreferencesController ([#4732](https://github.com/MetaMask/core.git/pull/4732))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/preferences-controller@13.1.0...HEAD

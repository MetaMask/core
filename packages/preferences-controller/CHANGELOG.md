...
- Update Release 412.0.0
- Initialize Release 412.0.0
- feat: integrate phishing protection into NftController ([#5598](https://github.com/MetaMask/core/pull/5598))
- Release/411.0.0 ([#5865](https://github.com/MetaMask/core/pull/5865))
- fix: remove leading zeroes in authorization list ([#5830](https://github.com/MetaMask/core/pull/5830))
- Adds `transactionBatches` into transaction controller state ([#5793](https://github.com/MetaMask/core/pull/5793))
...
- fix: detectTokens on tx confirmed ([#5859](https://github.com/MetaMask/core/pull/5859))
- feat(address-book): messaging updated and deleted events ([#5779](https://github.com/MetaMask/core/pull/5779))
- fix(rpc-service): improve error handling for HTTP status codes ([#5843](https://github.com/MetaMask/core/pull/5843))
- Add `@metamask/error-reporting-service` ([#5849](https://github.com/MetaMask/core/pull/5849))
- Release/408.0.0 ([#5854](https://github.com/MetaMask/core/pull/5854))
- chore: reduce tokenBalances state updates ([#5726](https://github.com/MetaMask/core/pull/5726))
...
- Add swappable param to discovery endpoints ([#5819](https://github.com/MetaMask/core/pull/5819))
- feat(accounts-controller): Add `entropySource` to new `InternalAccount` ([#5841](https://github.com/MetaMask/core/pull/5841))
- Release/406.0.0 ([#5845](https://github.com/MetaMask/core/pull/5845))
- Release/405.0.0 ([#5842](https://github.com/MetaMask/core/pull/5842))
- chore: update bridge config to v2 ([#5837](https://github.com/MetaMask/core/pull/5837))
- fix: Remove lingering decimal in return of `gweiDecimalToWeiDecimal` ([#5839](https://github.com/MetaMask/core/pull/5839))
- chore: EVM swap tx submission and events ([#5829](https://github.com/MetaMask/core/pull/5829))
- chore: add a test for extra fields in validator ([#5835](https://github.com/MetaMask/core/pull/5835))
- chore: add minimumVersion field and fix tests ([#5834](https://github.com/MetaMask/core/pull/5834))
- fix: add optional account for fetching historical prices ([#5833](https://github.com/MetaMask/core/pull/5833))
- Release/404.0.0 ([#5832](https://github.com/MetaMask/core/pull/5832))
- fix: don't poll for swap status ([#5831](https://github.com/MetaMask/core/pull/5831))
- feat: add sequential batch support ([#5762](https://github.com/MetaMask/core/pull/5762))
- fix: Add `userFeeLevel` as `dappSuggested` initially when `txParams` contains gas values for `legacy` transactions ([#5821](https://github.com/MetaMask/core/pull/5821))
- Release/403.0.0 ([#5826](https://github.com/MetaMask/core/pull/5826))
- feat: add types for unified bridge ui ([#5783](https://github.com/MetaMask/core/pull/5783))
- chore: calc slippage percentage ([#5723](https://github.com/MetaMask/core/pull/5723))
- fix: Fix sending native token to smart account ([#5822](https://github.com/MetaMask/core/pull/5822))
- Release 402.0.0 ([#5820](https://github.com/MetaMask/core/pull/5820))
- feat: log bridge quote and status validation errors ([#5816](https://github.com/MetaMask/core/pull/5816))
- Release/401.0.0 ([#5818](https://github.com/MetaMask/core/pull/5818))
- update @metamask/api-specs version to v0.14.0 in @metamask/chain-agnostic-permission + @metamask/multichain-api-middleware ([#5817](https://github.com/MetaMask/core/pull/5817))
- feat(multichain-transactions-controller)!: store transactions by chain ID (support for devnet chains) ([#5756](https://github.com/MetaMask/core/pull/5756))
...
- feat: Update `txParams` gas properties in when controller `updateTransactionGasFees` method is called with `userFeeLevel` ([#5800](https://github.com/MetaMask/core/pull/5800))
- fix: cancel upgrade error code ([#5814](https://github.com/MetaMask/core/pull/5814))
- fix: Prevent circuit break for HTTP 4XX errors ([#5809](https://github.com/MetaMask/core/pull/5809))
- Release/398.0.0 ([#5811](https://github.com/MetaMask/core/pull/5811))
- fix: use zero address as native address instead of assetId ([#5799](https://github.com/MetaMask/core/pull/5799))
- chore: Remove obsolete workaround ([#5808](https://github.com/MetaMask/core/pull/5808))
- feat: incoming transaction request tags ([#5803](https://github.com/MetaMask/core/pull/5803))
- fix(rpc-service): handle 405 and 429 status codes without triggering circuit breaker ([#5798](https://github.com/MetaMask/core/pull/5798))
- perf: improve token-list-controller state updates and caching ([#5804](https://github.com/MetaMask/core/pull/5804))

...
- fix(preferences-controller): skip sync when locking ([#3946](https://github.com/MetaMask/core.git/pull/3946))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/preferences-controller@7.0.0...HEAD

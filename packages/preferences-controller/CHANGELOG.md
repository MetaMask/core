...
- Restore previous behavior of toChecksumHexAddress ([#4046](https://github.com/MetaMask/core.git/pull/4046))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/preferences-controller@9.0.1...HEAD

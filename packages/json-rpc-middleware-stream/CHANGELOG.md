...
- fix(devDeps/json-rpc-middleware-stream): Bump extension-port-stream from ^2.0.1 to ^3.0.0 ([#3806](https://github.com/MetaMask/core.git/pull/3806))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/json-rpc-middleware-stream@6.0.2...HEAD

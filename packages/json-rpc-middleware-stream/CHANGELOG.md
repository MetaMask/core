...
- Release/297.0.0 ([#5305](https://github.com/MetaMask/core/pull/5305))
...
- fix(devDeps/json-rpc-middleware-stream): Bump extension-port-stream from ^2.0.1 to ^3.0.0 ([#3806](https://github.com/MetaMask/core/pull/3806))

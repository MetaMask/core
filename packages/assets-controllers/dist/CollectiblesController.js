 ...
 */
class CollectiblesController extends base_controller_1.BaseController {
    /**
    ...
    getCollectibleInformationFromApi(contractAddress, tokenId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let collectibleInformation = yield (0, controller_utils_1.fetchWithErrorHandling)({
            ...
            if (!collectibleInformation && this.openSeaApiKey) {
                collectibleInformation = yield (0, controller_utils_1.fetchWithErrorHandling)({
                    url: this.getCollectibleApi({
                        contractAddress,
                        tokenId,
                        useProxy: false,
    ...
    getCollectibleContractInformationFromApi(contractAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            /* istanbul ignore if */
            let apiCollectibleContractObject = yield (0, controller_utils_1.fetchWithErrorHandling)({
            ...
            if (this.openSeaApiKey) {
                apiCollectibleContractObject = yield (0, controller_utils_1.fetchWithErrorHandling)({
                    url: this.getCollectibleContractInformationApi({
                        contractAddress,
                        useProxy: false,
                    }),

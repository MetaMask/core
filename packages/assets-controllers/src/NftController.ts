    ...
    try {
      ...
      for (const {
        ...
        try {
          ...
          contractInformation = await this.#getNftContractInformation(
            checksumHexAddress,
            nftMetadata,
            networkClientId,
          );
          ...
          console.error(
            `NftController: Failed to fetch contract information for ${checksumHexAddress}`,
            error,
          );
          continue;
        }

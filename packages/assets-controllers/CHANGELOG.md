...
- feat: Integrate new `TokenListController` polling pattern [Core] ([#4878](https://github.com/MetaMask/core.git/pull/4878))
- feat: Show Staked ETH position in mobile homepage along with other tokens ([#4879](https://github.com/MetaMask/core.git/pull/4879))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/assets-controllers@42.0.0...HEAD

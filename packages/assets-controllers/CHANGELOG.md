...
- Updated `ApprovalController` method calls (`accept` → `acceptRequest`) and replaced `AddApprovalRequest` type alias with `ApprovalControllerAddRequestAction` ([#8183](https://github.com/MetaMask/core/pull/8183))

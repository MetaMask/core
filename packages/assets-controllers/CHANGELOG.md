...
- feat: update currency rate controller polling input ([#4839](https://github.com/MetaMask/core.git/pull/4839))
- Release 226.0.0 ([#4834](https://github.com/MetaMask/core.git/pull/4834))
- fix: should not reset market data after switch network ([#4832](https://github.com/MetaMask/core.git/pull/4832))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/assets-controllers@39.0.0...HEAD

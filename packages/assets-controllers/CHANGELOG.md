...
- bump contract metadata package version ([#1141](https://github.com/MetaMask/controllers.git/pull/1141))
...
[Unreleased]: https://github.com/MetaMask/controllers.git/compare/@metamask/assets-controllers@5.0.1...HEAD

...
- Optimize NFT Controller state writes from O(n) to O(1) for NFT detection by batching contract and NFT additions ([#8079](https://github.com/MetaMask/core/pull/8079))

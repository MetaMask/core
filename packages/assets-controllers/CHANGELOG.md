...
- fix: handle multicall revert in `TokenBalancesController` ([#5083](https://github.com/MetaMask/core.git/pull/5083))
- Bump `@metamask/utils` to `^11.0.1` and `@metamask/rpc-errors` to `^7.0.2` ([#5080](https://github.com/MetaMask/core.git/pull/5080))
- fix: Prevent State Changes for ignoreTokens on Non-Current Network ([#5014](https://github.com/MetaMask/core.git/pull/5014))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/assets-controllers@45.1.2...HEAD

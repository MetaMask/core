...
- fix: prevent non-current network tokens from being hidden incorrectly ([#4967](https://github.com/MetaMask/core.git/pull/4967))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/assets-controllers@45.1.0...HEAD

...
- Bump `@metamask/account-tree-controller` devDependency from `^0.8.0` to `^0.9.0`
...
- Bump `@metamask/account-tree-controller` from `^0.7.0` to `^0.9.0` ([#6331](https://github.com/MetaMask/core/pull/6331))

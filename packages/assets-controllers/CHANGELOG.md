...
- Fix TokenDetectionController.detectTokens() used tokens states when passed networkClientId ([#3914](https://github.com/MetaMask/core.git/pull/3914))
- Release 116.0.0 ([#3915](https://github.com/MetaMask/core.git/pull/3915))
- fix: NFT detection running too many times ([#3917](https://github.com/MetaMask/core.git/pull/3917))
- fix: fix import ERC20 on network 1337 ([#3777](https://github.com/MetaMask/core.git/pull/3777))
- [token-detection-controller] Add tests for API changes from merge with `DetectTokensController` ([#3867](https://github.com/MetaMask/core.git/pull/3867))
- any type in asset-controller classes have been fixed with a proper types ([#3818](https://github.com/MetaMask/core.git/pull/3818))
- deps: bump @metamask/ethjs- packages to latest ([#3897](https://github.com/MetaMask/core.git/pull/3897))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/assets-controllers@25.0.0...HEAD

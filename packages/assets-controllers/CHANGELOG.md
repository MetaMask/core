...
- fix: fix case when metadata are null ([#5455](https://github.com/MetaMask/core.git/pull/5455))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/assets-controllers@53.1.0...HEAD

...
- Add 30-second timeout protection for Accounts API calls in `TokenDetectionController` to prevent hanging requests ([#xxxx](https://github.com/MetaMask/core/pull/xxxx))

...
- fix: prevent undefined or empty currencies from being queried ([#5458](https://github.com/MetaMask/core.git/pull/5458))
- fix: improve token rate response aborting ([#5531](https://github.com/MetaMask/core.git/pull/5531))
- Release 338.0.0 ([#5518](https://github.com/MetaMask/core.git/pull/5518))
- Revert "feat: add `MegaEth Testnet` as default network" ([#5520](https://github.com/MetaMask/core.git/pull/5520))
- feat: add `MegaEth Testnet` as default network ([#5506](https://github.com/MetaMask/core.git/pull/5506))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/assets-controllers@55.0.1...HEAD

...
- refactor: Fix misnamed parameter name ([#4108](https://github.com/MetaMask/core.git/pull/4108))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/base-controller@5.0.1...HEAD

...
- [base-controller] Fix `any` usage in `BaseControllerV1` ([#3959](https://github.com/MetaMask/controllers/pull/3959))
...
[Unreleased]: https://github.com/MetaMask/controllers/compare/@metamask/base-controller@4.1.1...HEAD

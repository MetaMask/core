...
var RestrictedControllerMessenger = class {
  ...
  constructor({
     ...
     */
    __privateAdd(this, _isAllowedEvent);
    /**
     ...
     */
    __privateAdd(this, _isAllowedAction);
    /**
     ...
     */
    __privateAdd(this, _isInCurrentNamespace);
    __privateAdd(this, _controllerMessenger, void 0);
    __privateAdd(this, _controllerName, void 0);
    __privateAdd(this, _allowedActions, void 0);
    __privateAdd(this, _allowedEvents, void 0);
    __privateSet(this, _controllerMessenger, controllerMessenger);
    __privateSet(this, _controllerName, name);
    __privateSet(this, _allowedActions, allowedActions);
    __privateSet(this, _allowedEvents, allowedEvents);
  }
  /**
  ...
  registerActionHandler(action, handler) {
    if (!__privateMethod(this, _isInCurrentNamespace, isInCurrentNamespace_fn).call(this, action)) {
      throw new Error(
        `Only allowed registering action handlers prefixed by '${__privateGet(this, _controllerName)}:'`
      );
    }
    __privateGet(this, _controllerMessenger).registerActionHandler(action, handler);
  }
  /**
  ...
  unregisterActionHandler(action) {
    if (!__privateMethod(this, _isInCurrentNamespace, isInCurrentNamespace_fn).call(this, action)) {
      throw new Error(
        `Only allowed unregistering action handlers prefixed by '${__privateGet(this, _controllerName)}:'`
      );
    }
    __privateGet(this, _controllerMessenger).unregisterActionHandler(action);
  }
  /**
   * Call an action.
   *
  ...
  call(actionType, ...params) {
    if (!__privateMethod(this, _isAllowedAction, isAllowedAction_fn).call(this, actionType)) {
      throw new Error(`Action missing from allow list: ${actionType}`);
    }
    const response = __privateGet(this, _controllerMessenger).call(
      actionType,
      ...params
    );
    return response;
  ...
  registerInitialEventPayload({
    ...
    if (!__privateMethod(this, _isInCurrentNamespace, isInCurrentNamespace_fn).call(this, eventType)) {
      throw new Error(
        `Only allowed publishing events prefixed by '${__privateGet(this, _controllerName)}:'`
      );
    }
    __privateGet(this, _controllerMessenger).registerInitialEventPayload({
      eventType,
      getPayload
    });
  }
  ...
  publish(event, ...payload) {
    if (!__privateMethod(this, _isInCurrentNamespace, isInCurrentNamespace_fn).call(this, event)) {
      throw new Error(
        `Only allowed publishing events prefixed by '${__privateGet(this, _controllerName)}:'`
      );
    }
    __privateGet(this, _controllerMessenger).publish(event, ...payload);
  }
  subscribe(event, handler, selector) {
    if (!__privateMethod(this, _isAllowedEvent, isAllowedEvent_fn).call(this, event)) {
      throw new Error(`Event missing from allow list: ${event}`);
    }
    if (selector) {
      return __privateGet(this, _controllerMessenger).subscribe(event, handler, selector);
    }
    return __privateGet(this, _controllerMessenger).subscribe(event, handler);
  }
  /**
  ...
  unsubscribe(event, handler) {
    ...
    __privateGet(this, _controllerMessenger).unsubscribe(event, handler);
  }
  /**
  ...
  clearEventSubscriptions(event) {
    if (!__privateMethod(this, _isInCurrentNamespace, isInCurrentNamespace_fn).call(this, event)) {
      throw new Error(
        `Only allowed clearing events prefixed by '${__privateGet(this, _controllerName)}:'`
      );
    }
    __privateGet(this, _controllerMessenger).clearEventSubscriptions(event);
  }
};
...
isAllowedEvent_fn = function(eventType) {
  const allowedEvents = __privateGet(this, _allowedEvents);
  return __privateMethod(this, _isInCurrentNamespace, isInCurrentNamespace_fn).call(this, eventType) || allowedEvents !== null && allowedEvents.includes(eventType);
};
_isAllowedAction = new WeakSet();
isAllowedAction_fn = function(actionType) {
  const allowedActions = __privateGet(this, _allowedActions);
  return __privateMethod(this, _isInCurrentNamespace, isInCurrentNamespace_fn).call(this, actionType) || allowedActions !== null && allowedActions.includes(actionType);
};
_isInCurrentNamespace = new WeakSet();
isInCurrentNamespace_fn = function(name) {
  return name.startsWith(`${__privateGet(this, _controllerName)}:`);
};

export {
  RestrictedControllerMessenger
};
//# sourceMappingURL=chunk-EJ5YPJOH.mjs.map
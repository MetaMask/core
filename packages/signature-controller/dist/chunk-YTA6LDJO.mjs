...
var SignatureController = class extends BaseController {
  /**
  ...
  constructor({
    ...
    __privateSet(this, _personalMessageManager, new PersonalMessageManager(
      void 0,
      void 0,
      securityProviderRequest
    ));
    __privateSet(this, _typedMessageManager, new TypedMessageManager(
      void 0,
      void 0,
      securityProviderRequest,
      void 0,
...
newUnsignedAbstractMessage_fn = async function(messageManager, approvalType, signTypeForLogger, messageName, signMessage, messageParams, req, version, signingOpts) {
  ...
  try {
    ...
    try {
      __privateMethod(this, _addLog, addLog_fn).call(this, signTypeForLogger, SigningStage.Proposed, messageParamsWithId);
      ...
      __privateMethod(this, _addLog, addLog_fn).call(this, signTypeForLogger, SigningStage.Rejected, messageParamsWithId);
    ...
    __privateMethod(this, _addLog, addLog_fn).call(this, signTypeForLogger, SigningStage.Signed, messageParamsWithId);
...
signPersonalMessage_fn = async function(msgParams) {
  return await __privateMethod(this, _signAbstractMessage, signAbstractMessage_fn).call(this, __privateGet(this, _personalMessageManager), ApprovalType.PersonalSign, msgParams, async (cleanMsgParams) => await this.messagingSystem.call(
...
signTypedMessage_fn = async function(msgParams, opts = { parseJsonData: true }) {
  ...
  return await __privateMethod(this, _signAbstractMessage, signAbstractMessage_fn).call(this, __privateGet(this, _typedMessageManager), ApprovalType.EthSignTypedData, msgParams, async (cleanMsgParams) => {
...
//# sourceMappingURL=chunk-YTA6LDJO.mjs.map
...
- feat: remove global network from signature controller ([#4797](https://github.com/MetaMask/core.git/pull/4797))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/signature-controller@20.1.0...HEAD

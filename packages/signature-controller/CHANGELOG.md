...
- Bump `@metamask/gator-permissions-controller` from `^1.1.2` to `^2.0.0` ([#7937](https://github.com/MetaMask/core/pull/7937)
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/signature-controller@39.0.2...HEAD

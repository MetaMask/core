...
- Fix invalid type import path in `@metamask/multichain` ([#5313](https://github.com/MetaMask/core.git/pull/5313))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/multichain@2.1.1...HEAD

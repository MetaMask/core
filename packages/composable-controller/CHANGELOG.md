...
- [composable-controller] Remove `flatState` getter ([#3877](https://github.com/MetaMask/core.git/pull/3877))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/composable-controller@5.0.1...HEAD

...
- chore(composable-controller): replace `Sinon` with `Jest` mocks ([#7964](https://github.com/MetaMask/core/pull/7964))
...
- chore(lint): Fix suppressed ESLint errors in `composable-controller` package ([#7462](https://github.com/MetaMask/core/pull/7462))
...
- Release 263.0.0 ([#5023](https://github.com/MetaMask/core/pull/5023))
...
- Simplify composable controller tests ([#1077](https://github.com/MetaMask/core/pull/1077))
- Release 39.0.0 ([#1066](https://github.com/MetaMask/core/pull/1066))
- Remove unknown type from address types ([#1068](https://github.com/MetaMask/core/pull/1068))
- Add addressType flag in the address book contoller ([#828](https://github.com/MetaMask/core/pull/828))
- Release 36.0.0 ([#999](https://github.com/MetaMask/core/pull/999))
- Change naming of provider to providerConfig where applicable ([#995](https://github.com/MetaMask/core/pull/995))

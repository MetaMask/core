...
- Depend on `@metamask/contract-metadata` from GitHub instead of npm so the lockfile tracks the latest published contract map ([#TBD](https://github.com/MetaMask/core/pull/TBD))

...
- Include `layer1GasFee` in local transaction network fees so Mantle and other OP Stack activities reflect the confirmed L1 / operator fee paid onchain ([#9630](https://github.com/MetaMask/core/pull/9630))

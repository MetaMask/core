...
describe('RewardsController', () => {
  ...
  describe('getPointsEvents', () => {
    ...
    it('should handle getPointsEvents errors and return it when the error is not an object', async () => {
      const mockRequest = {
        seasonId: 'current',
        subscriptionId: 'sub-123',
        cursor: null,
      ...
      await expect(controller.getPointsEvents(mockRequest)).rejects.toBe(
        'not error object',
      );

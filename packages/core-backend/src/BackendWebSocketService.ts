...
export class BackendWebSocketService {
  ...
  #scheduleConnect(): void {
    ...
    // First attempt (reconnectAttempts=1) → 500ms
    // Second attempt (reconnectAttempts=2) → 750ms
    // Third attempt (reconnectAttempts=3) → 1125ms
    // Continues up to maxReconnectDelay (5000ms)
    const rawDelay =

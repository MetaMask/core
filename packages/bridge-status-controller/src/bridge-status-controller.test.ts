...
describe('BridgeStatusController', () => {
  ...
  describe('submitTx: Tron swap with approval', () => {
    const mockTronApproval: TronTradeData = {
      raw_data_hex: '0a02aabb22084dde86d0f68ae3e5403a680801b2630a31747970652e676f6f676c65617069732e636f6d2f70726f746f636f6c2e54726967676572536d617274436f6e747261637412330a15418f7ea8cce9f8bba67d7ae59cd49a1965d617e71a121541a614f803b6fd780986a42c78ec9c7f77e6ded13c',
    };

    const mockTronTrade: TronTradeData = {
      raw_data_hex: '0a02aabb22084dde86d0f68ae3e5403a680801b2630a31747970652e676f6f676c65617069732e636f6d2f70726f746f636f6c2e54726967676572536d617274436f6e747261637412330a15418f7ea8cce9f8bba67d7ae59cd49a1965d617e71b121541a614f803b6fd780986a42c78ec9c7f77e6ded13c',
    };
    ...
    const mockQuoteResponse: QuoteResponse<TronTradeData, TronTradeData> &
      ...
      quote: {
        ...
        srcAsset: {
          ...
          name: 'Tether USD',
          decimals: 6,
          assetId: 'bip122:000000000019d6689c085ae165831e93/slip44:195',
        },

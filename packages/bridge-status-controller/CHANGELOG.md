...
- Bump `@metamask/profile-sync-controller` from `^29.0.0` to `^30.0.0` ([#9824](https://github.com/MetaMask/core/pull/9824))
- Bump `@metamask/bridge-controller` from `^79.3.0` to `^79.3.1` ([#9936](https://github.com/MetaMask/core/pull/9936))
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/bridge-status-controller@75.2.1...HEAD

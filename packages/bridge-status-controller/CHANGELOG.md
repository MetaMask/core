...
- Bump `@metamask/bridge-controller` from `^75.0.0` to `^75.2.0` ([#9078](https://github.com/MetaMask/core/pull/9078), [#9147](https://github.com/MetaMask/core/pull/9147))
...
[72.2.0]: https://github.com/MetaMask/core/compare/@metamask/bridge-status-controller@72.1.0...@metamask/bridge-status-controller@72.2.0

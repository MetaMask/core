...
- Add support for Bitcoin bridge transactions
...
- Rename `handleSolanaTxResponse` to `handleNonEvmTxResponse` for clarity
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/bridge-status-controller@43.0.0...HEAD

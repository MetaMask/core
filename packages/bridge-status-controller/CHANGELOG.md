...
- Bump `@metamask/bridge-controller` to `^32.2.0` ([#5969](https://github.com/MetaMask/core/pull/5969))
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/bridge-status-controller@29.2.0...HEAD
[29.2.0]: https://github.com/MetaMask/core/compare/@metamask/bridge-status-controller@29.1.0...@metamask/bridge-status-controller@29.2.0

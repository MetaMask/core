...
- Allow `quick_buy_explore` feature id to emit `Submitted`, `Completed`, and `Failed` Unified SwapBridge status events ([#TBD](https://github.com/MetaMask/core/pull/TBD))

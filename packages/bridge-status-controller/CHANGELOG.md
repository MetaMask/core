...
- Bump `@metamask/transaction-controller` from `^69.5.0` to `^69.6.0` ([#9798](https://github.com/MetaMask/core/pull/9798), [#9822](https://github.com/MetaMask/core/pull/9822))

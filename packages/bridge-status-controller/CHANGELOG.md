...
- feat: add multichain support to bridge-controller ([#5486](https://github.com/MetaMask/core.git/pull/5486))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/bridge-status-controller@10.0.0...HEAD

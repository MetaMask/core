...
- Include quote's `slippage` value in post-submission MixPanel event properties
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/bridge-status-controller@74.6.2...HEAD

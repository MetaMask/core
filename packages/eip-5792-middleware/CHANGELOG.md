...
- Bump `@metamask/transaction-controller` from `^60.6.1` to `^60.8.0` ([#6841](https://github.com/MetaMask/core/pull/6841), [#6883](https://github.com/MetaMask/core/pull/6883))

...
- Bump `@metamask/transaction-controller` from `^70.0.0` to `^70.0.2` ([#10242](https://github.com/MetaMask/core/pull/10242), [#10262](https://github.com/MetaMask/core/pull/10262))

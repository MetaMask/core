...
- Bump `@metamask/transaction-controller` from `^61.0.0` to `^62.0.0` ([#7007](https://github.com/MetaMask/core/pull/7007), [#XXXX](https://github.com/MetaMask/core/pull/XXXX))

...
- Add top gainers losers to token discovery service ([#5309](https://github.com/MetaMask/controllers.git/pull/5309))
...
[Unreleased]: https://github.com/MetaMask/controllers.git/compare/@metamask/token-search-discovery-controller@2.1.0...HEAD
[2.1.0]: https://github.com/MetaMask/controllers.git/compare/@metamask/token-search-discovery-controller@2.0.0...@metamask/token-search-discovery-controller@2.1.0
[2.0.0]: https://github.com/MetaMask/controllers.git/compare/@metamask/token-search-discovery-controller@1.0.0...@metamask/token-search-discovery-controller@2.0.0
[1.0.0]: https://github.com/MetaMask/controllers.git/releases/tag/@metamask/token-search-discovery-controller@1.0.0

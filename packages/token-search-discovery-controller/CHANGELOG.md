...
- Add top gainers losers to token discovery service ([#5309](https://github.com/MetaMask/core.git/pull/5309))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/token-search-discovery-controller@2.1.0...HEAD

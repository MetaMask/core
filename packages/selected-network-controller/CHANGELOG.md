...
## [Unreleased]
### Added
- Add `SelectedNetworkMiddlewareMessenger`, `SelectedNetworkMiddlewareJsonRpcRequest` types ([#1970](https://github.com/MetaMask/core/pull/1970)).

### Changed
- **BREAKING:** Renamed `SelectedNetworkControllerAction` to `SelectedNetworkControllerActions` and `SelectedNetworkControllerEvent` to `SelectedNetworkControllerEvents` for consistency with corresponding type exports from other controllers ([#1970](https://github.com/MetaMask/core/pull/1970)).

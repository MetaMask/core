...
/**
 * Registry hosts where PDS scans include the URL path (shared gateways / hosts where many sites
...
/**
 * Builds the `url` query parameter for the phishing-detection scan API. For hosts in

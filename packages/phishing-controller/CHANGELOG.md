...
- Reduce default cache TTL for `DEFAULT_URL_SCAN_CACHE_TTL`, `DEFAULT_TOKEN_SCAN_CACHE_TTL`, and `DEFAULT_ADDRESS_SCAN_CACHE_TTL` from 15 minutes to 1 minute ([#XXXX](https://github.com/MetaMask/core/pull/XXXX))
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/phishing-controller@17.0.0...HEAD

...
- Updated pooling intervals ([#4202](https://github.com/MetaMask/core.git/pull/4202))
  - Updated the Stalelist interval to 30 days and the hotlist interval to 5 mins
- Bump controller-utils version to `~9.1.0` ([#4153](https://github.com/MetaMask/core.git/pull/4153))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/phishing-controller@9.0.2...HEAD

 ...
 * {@link CoalescingBatchFetcher.fetch}).
 *
...
export type CoalescingBatchFetcherOptions<Key extends string, Value> = {
 ...
 */
export class CoalescingBatchFetcher<Key extends string, Value> {
  ...
  constructor(options: CoalescingBatchFetcherOptions<Key, Value>) {

...
```typescript
{
  ...
  // Selected accounts (getter from AccountTreeController)
  get selectedAccounts(): InternalAccount[],

  // Enabled chains from NetworkEnablementController
  enabledChains: ChainId[],

  // Available chains per data source (key: sourceId)
  dataSources: Map<string, Set<ChainId>>,

  // Active subscriptions by subscription key (e.g., "ds:BackendWebsocketDataSource")
  activeSubscriptions: Map<string, SubscriptionResponse>,

  // Active price subscription ID

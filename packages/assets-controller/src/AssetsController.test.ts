...
describe('AssetsController', () => {
  ...
  describe('handleAssetsUpdate - state updates', () => {
    ...
    it('preserves balance metadata enrichment when merge update changes amount', async () => {
      const initialState: Partial<AssetsControllerState> = {
        assetsBalance: {
          [MOCK_ACCOUNT_ID]: {
            [MOCK_ASSET_ID]: {
    ...
    it('preserves balance metadata when replaceCoveredChainBalances updates amount only', async () => {
      const initialState: Partial<AssetsControllerState> = {
        assetsBalance: {
          [MOCK_ACCOUNT_ID]: {
            [MOCK_ASSET_ID]: {

...
| [`03-fallback-cascade`](./03-fallback-cascade.png)     | sequence     | How one EVM chain degrades from Accounts API to RPC to per-account calls    |
...
All six pass `deliver` at the `showcase` quality profile. All except

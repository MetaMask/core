...
- Bump `@metamask/client-controller` from `^1.0.1` to `^1.1.0` ([#8733](https://github.com/MetaMask/core/pull/8733))
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/assets-controller@6.5.0...HEAD
[6.5.0]: https://github.com/MetaMask/core/compare/@metamask/assets-controller@6.4.0...@metamask/assets-controller@6.5.0

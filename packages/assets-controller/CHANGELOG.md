...
- Add `isEnabled` option to `AssetsController`, `initMessengers`, and `initDataSources` to conditionally skip initialization when disabled ([#7831](https://github.com/MetaMask/core/pull/7831))

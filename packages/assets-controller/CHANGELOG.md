...
- Add a transient, non-persisted per-account assets loading state (`assetsLoadingStatus`) that marks accounts as loading during account switches and unlock, with selectors to read it ([#10230](https://github.com/MetaMask/core/pull/10230))

...
- Bump `@metamask/assets-controllers` from `^100.0.3` to `^100.1.0` ([#](https://github.com/MetaMask/core/pull/))
- Bump `@metamask/network-enablement-controller` from `^4.1.2` to `^4.2.0` ([#](https://github.com/MetaMask/core/pull/))

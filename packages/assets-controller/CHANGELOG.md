...
- Bump `@metamask/keyring-internal-api` from `^10.1.1` to `^11.0.1` ([#8584](https://github.com/MetaMask/core/pull/8584), [#XXXX](https://github.com/MetaMask/core/pull/XXXX))
- Bump `@metamask/keyring-snap-client` from `^9.0.1` to `^9.0.2` ([#XXXX](https://github.com/MetaMask/core/pull/XXXX))

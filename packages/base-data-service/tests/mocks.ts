...
export const TRANSACTIONS_PAGE_3_START_CURSOR =
...
export function mockTransactionsPage2(mockReply?: MockReply): nock.Scope {
  ...
  return nock('https://accounts.api.cx.metamask.io:443', {
    ...
    .query(
      (args) =>
        args.limit === '3' &&
        args.accountAddresses ===
          'eip155:0:0x4bbeeb066ed09b7aed07bf39eee0460dfa261520' &&
        (args.before === TRANSACTIONS_PAGE_3_START_CURSOR ||
          args.after === TRANSACTIONS_PAGE_2_CURSOR),
    )
    .reply(reply.status, reply.body);
}
  ...
  const reply = mockReply ?? {
    ...
    body: {
      ...
      pageInfo: {
        ...
        startCursor: TRANSACTIONS_PAGE_3_START_CURSOR,
        endCursor:

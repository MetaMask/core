...
- Export `selectMaxBalanceButtonVisibilityForSrcToken` which returns whether a native asset is eligible for gas-included swaps ([#6051](https://github.com/MetaMask/core/pull/6051))

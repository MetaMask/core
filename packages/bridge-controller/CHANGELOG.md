...
- Bump `@metamask/gas-fee-controller` to `^26.0.0` ([#XXXX](https://github.com/MetaMask/core/pull/XXXX))
- Bump `@metamask/multichain-network-controller` to `^3.0.0` ([#XXXX](https://github.com/MetaMask/core/pull/XXXX))

...
- Emit `failure_phase`, `error_code`, `source_hash_present`, and `destination_hash_present` on Quotes Error and Failed events ([#9949](https://github.com/MetaMask/core/pull/9949))

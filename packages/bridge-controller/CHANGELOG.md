...
- Bump `@metamask/assets-controllers` to `^61.1.0` ([#5777](https://github.com/MetaMask/core/pull/5777))
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/bridge-controller@21.0.0...HEAD

...
- **BREAKING:** Add required property `minimumBalanceForRentExemptionInLamports` to `BridgeState`. adds selector `selectMinimumBalanceForRentExemptionInSOL`, and adds a new dependency `uuid`. ([#5827](https://github.com/MetaMask/core/pull/5827))

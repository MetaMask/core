...
- **BREAKING**: Move `selectedAccountGroup` to top-level persisted state to prevent selected account group from reverting after app restart ([#XXX](https://github.com/MetaMask/core/pull/XXX))

...
- **BREAKING:** Bump peer dependency `@metamask/multichain-account-service` to `^3.0.0` ([#XXXX](https://github.com/MetaMask/core/pull/XXXX))
- Bump `@metamask/multichain-account-service` to `^2.1.0` ([#7019](https://github.com/MetaMask/core/pull/7019), [#7041](https://github.com/MetaMask/core/pull/7041))

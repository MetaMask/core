...
- The `Multichain Account Syncing - Full` trace is now only emitted when a backup-and-sync run actually mutates local or remote state, and the span is backdated to preserve the real sync duration ([#9343](https://github.com/MetaMask/core/pull/9343))

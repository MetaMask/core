...
- fix: Persist user rejection optional data in rejected error ([#5355](https://github.com/MetaMask/core.git/pull/5355))
- Release 302.0.0 ([#5346](https://github.com/MetaMask/core.git/pull/5346))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/transaction-controller@46.0.0...HEAD

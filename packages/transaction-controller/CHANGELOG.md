...
- feat: Configure pending transaction polling intervals using remote fe… ([#5549](https://github.com/MetaMask/core.git/pull/5549))
- fix: Remove async operation from `updateTransactionGasFees` ([#5539](https://github.com/MetaMask/core.git/pull/5539))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/transaction-controller@52.3.0...HEAD

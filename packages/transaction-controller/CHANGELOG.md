...
- fix: Rename `enableTxParamsGasFeeUpdates` to `isAutomaticGasFeeUpdateEnabled` and also callback ([#5602](https://github.com/MetaMask/core.git/pull/5602))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/transaction-controller@53.0.0...HEAD

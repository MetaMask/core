...
- Remove chainIds argument from startIncomingTransactionPolling, stopIncomingTransactionPolling, updateIncomingTransactions functions. ([#4358](https://github.com/MetaMask/MetaMask-planning/issues/4358))

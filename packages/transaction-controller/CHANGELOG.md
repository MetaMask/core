...
- Add versioned, chain-agnostic Pay intent metadata for persisting CAIP source identity, one-attempt execution checkpoints, and provider correlation without changing legacy EVM Pay fields.

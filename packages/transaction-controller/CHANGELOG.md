...
- fix: parsing of non-string event arguments from simulation ([#4512](https://github.com/MetaMask/core.git/pull/4512))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/transaction-controller@35.0.0...HEAD

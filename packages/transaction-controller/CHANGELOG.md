...
- Move `immer` from devDependencies to dependencies ([#10382](https://github.com/MetaMask/core/pull/10382))
  - It is imported by `src/utils/batch.ts` and appears in the published type declarations, so consumers need it resolvable.

...
- Added the `PhishingController:bulkScanTokens` as an allowed action in the `TransactionController` messengers ([#6337](https://github.com/MetaMask/core/pull/6337))

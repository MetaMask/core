...
- fix: Add validation to ensure gas fields are valid hexadecimal ([#4854](https://github.com/MetaMask/core.git/pull/4854))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/transaction-controller@38.2.0...HEAD

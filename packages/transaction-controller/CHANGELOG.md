...
- Fix `TransactionController:transactionApproved` event not to be emitted when there keyring throws during signing ([#7410](https://github.com/MetaMask/core/pull/7410))

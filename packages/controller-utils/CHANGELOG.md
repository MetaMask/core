...
- Add `BlockExplorerUrl` object and type for looking up the block explorer URL of any Infura network ([#4286](https://github.com/MetaMask/core/pull/4286))
- Add `NetworkNickname` object and type for looking up the common nickname for any Infura network ([#4286](https://github.com/MetaMask/core/pull/4286))
- Add `Partialize` type for making select keys in an object type optional ([#4286](https://github.com/MetaMask/core/pull/4286))
- `toHex` now supports converting a `bigint` into a hex string ([#4286](https://github.com/MetaMask/core/pull/4286))

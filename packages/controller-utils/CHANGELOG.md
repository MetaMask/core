...
- feat: add `MegaETH Testnet` to `controller-utils` ([#5495](https://github.com/MetaMask/core.git/pull/5495))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/controller-utils@11.6.0...HEAD

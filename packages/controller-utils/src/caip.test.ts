import { isEthCaipChainId, getCaipChainIdFromEthChainId, getEthChainIdDecFromCaipChainId, getEthChainIdHexFromCaipChainId,getEthChainIdIntFromCaipChainId  } from './caip';
...
describe('caip', () => {
  ...
  it('getEthChainIdIntFromCaipChainId', () => {
    expect(getEthChainIdHexFromCaipChainId("eip155:1")).toBe(1)
    expect(getEthChainIdHexFromCaipChainId("eip155:1337")).toBe(1337)
  })
});

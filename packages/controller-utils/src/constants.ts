...
export enum ApprovalType {
  ...
  GetProviderState = 'metamask_getProviderState',
  LogWeb3ShimUsage = 'metamask_logWeb3ShimUsage',
  PersonalSign = 'personal_sign',
  SendMetadata = 'metamask_sendDomainMetadata',
  SwitchEthereumChain = 'wallet_switchEthereumChain',
  WalletRequestPermissions = 'wallet_requestPermissions',
  WatchAsset = 'wallet_watchAsset',
  WatchAssetLegacy = 'metamask_watchAsset',
  SnapDialogAlert = 'snap_dialog:alert',
  SnapDialogConfirmation = 'snap_dialog:confirmation',
  SnapDialogPrompt = 'snap_dialog:prompt',
  MmiAuthenticate = 'metamaskinstitutional_authenticate',
  MmiReauthenticate = 'metamaskinstitutional_reauthenticate',
  MmiRefreshToken = 'metamaskinstitutional_refresh_token',
  MmiSupported = 'metamaskinstitutional_supported',
  MmiPortfolio = 'metamaskinstitutional_portfolio',
  MmiOpenSwaps = 'metamaskinstitutional_open_swaps',
  MmiCheckIfTokenIsPresent = 'metamaskinstitutional_checkIfTokenIsPresent',
  MmiSetAccountAndNetwork = 'metamaskinstitutional_setAccountAndNetwork',
  MmiOpenAddHardwareWallet = 'metamaskinstitutional_openAddHardwareWallet',
  Unlock = 'unlock',
}

...
- **BREAKING:** Add `AssetsControllerStateChangeEvent`, `CurrencyRateStateChange`, `TokenRatesControllerStateChangeEvent`, and `TokensControllerStateChangeEvent` to `AllowedEvents` ([#8714](https://github.com/MetaMask/core/pull/8714))
...
- Re-parse required tokens when asset state changes ([#8714](https://github.com/MetaMask/core/pull/8714))

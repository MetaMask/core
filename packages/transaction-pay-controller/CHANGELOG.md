...
- Bump `@metamask/bridge-status-controller` from `^72.1.1` to `^72.2.0` ([#9147](https://github.com/MetaMask/core/pull/9147))
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/transaction-pay-controller@23.13.1...HEAD

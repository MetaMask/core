...
- Bump `@metamask/assets-controller` from `^15.1.0` to `^16.0.0` ([#10155](https://github.com/MetaMask/core/pull/10155))
...
- Bump `@metamask/gas-fee-controller` from `^26.3.2` to `^27.0.0` ([#10155](https://github.com/MetaMask/core/pull/10155))
...
- Bump `@metamask/ramps-controller` from `^20.3.0` to `^21.0.0` ([#10155](https://github.com/MetaMask/core/pull/10155))
- Bump `@metamask/remote-feature-flag-controller` from `^6.1.1` to `^7.0.0` ([#10155](https://github.com/MetaMask/core/pull/10155))
- Bump `@metamask/sentinel-api-service` from `^1.0.1` to `^2.0.0` ([#10155](https://github.com/MetaMask/core/pull/10155))
...
- Add optional `resolveSourceAmount` constructor option to `TransactionPayController`, allowing clients to supply an exact atomic source amount for a required token that bypasses the default fiat-derived source calculation ([#9817](https://github.com/MetaMask/core/pull/9817))

...
- Use `EXACT_INPUT` Relay quotes for plain Perps and Predict deposits so the entered amount is the total source amount paid, while preserving `EXACT_OUTPUT` for HyperCore deposit-and-order flows ([#9954](https://github.com/MetaMask/core/pull/9954))

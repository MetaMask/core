...
- Bump `@metamask/bridge-status-controller` from `^72.2.0` to `^72.2.1` ([#9242](https://github.com/MetaMask/core/pull/9242))
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/transaction-pay-controller@23.14.0...HEAD

...
- refactor(permission-controller): Clean up use of `any` ([#4171](https://github.com/MetaMask/core.git/pull/4171))
- docs(permission-controller): Update ARCHITECTURE.md ([#4195](https://github.com/MetaMask/core.git/pull/4195))
- docs: Remove various TypeScript@4.4 TODOs ([#4196](https://github.com/MetaMask/core.git/pull/4196))
- feat(permission-controller): Allow passing additional metadata during requestPermissions ([#4179](https://github.com/MetaMask/core.git/pull/4179))
- feat(permission-controller): Re-throw all well-formed errors ([#4172](https://github.com/MetaMask/core.git/pull/4172))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/permission-controller@9.0.2...HEAD

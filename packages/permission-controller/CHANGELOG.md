...
## [7.0.0]
### Changed
- **BREAKING:** Bump `@metamask/approval-controller` from `^5.0.0` to `^5.1.1` ([#3680](https://github.com/MetaMask/core/pull/3680), [#3695](https://github.com/MetaMask/core/pull/3695))

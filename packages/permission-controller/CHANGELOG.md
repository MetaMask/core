...
## [7.1.0]
### Uncategorized
- Add `SubjectMetadataController:addSubjectMetadata` action ([#3733](https://github.com/MetaMask/controllers.git/pull/3733))
...
[Unreleased]: https://github.com/MetaMask/controllers.git/compare/@metamask/permission-controller@7.1.0...HEAD

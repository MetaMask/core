...
- Simplify `wallet_requestPermissions` implementation ([#3911](https://github.com/MetaMask/core.git/pull/3911))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/permission-controller@8.0.0...HEAD

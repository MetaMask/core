...
const onPermittedMock = jest.fn(async () => Promise.resolve('foo'));
const onFailureMock = jest.fn(async () => Promise.resolve());
const onPermitted = async () => onPermittedMock();
const onFailure = async () => onFailureMock();

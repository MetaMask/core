...
- Wire the `shieldApiService` slot in the daemon wallet's instance options with `fetch`, relying on the service's default production environment ([#9616](https://github.com/MetaMask/core/pull/9616))

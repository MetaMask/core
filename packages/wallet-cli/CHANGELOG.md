...
- Wire the `subscriptionService` slot in the daemon wallet's instance options (`SubscriptionEnv.PRD` and `globalThis.fetch`) ([#9598](https://github.com/MetaMask/core/pull/9598))

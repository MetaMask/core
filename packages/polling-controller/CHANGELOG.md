...
- [polling-controller] minor type refactors ([#4042](https://github.com/MetaMask/core.git/pull/4042))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/polling-controller@6.0.1...HEAD

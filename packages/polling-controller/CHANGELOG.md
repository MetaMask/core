...
- **BREAKING:** Use new `Messenger` from `@metamask/messenger` for `StaticIntervalPollingController` ([#6444](https://github.com/MetaMask/core/pull/6444))
  - Previously, `StaticIntervalPollingController` accepted a `RestrictedMessenger` instance from `@metamask/base-controller`.

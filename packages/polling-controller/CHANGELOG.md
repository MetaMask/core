...
- chore(polling-controller): replace Sinon with Jest fake timers ([#7966](https://github.com/MetaMask/core/pull/7966))
...
- chore(lint): Fix suppressed ESLint errors in `polling-controller` package ([#7435](https://github.com/MetaMask/core/pull/7435))
...
- [polling-controller] minor type refactors ([#4042](https://github.com/MetaMask/core/pull/4042))
...
- Changed Pollingcontroller method names ([#1742](https://github.com/MetaMask/core/pull/1742))
- Add `test:clean` build script that clears jest cache before running tests ([#1714](https://github.com/MetaMask/core/pull/1714))
- Changed PollingController to be a mixin so it can be used with both V1 and V2 controllers ([#1736](https://github.com/MetaMask/core/pull/1736))
...
- Added polling-controller ([#1703](https://github.com/MetaMask/core/pull/1703))

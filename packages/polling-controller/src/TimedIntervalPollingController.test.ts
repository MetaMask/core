...
import { TimedIntervalPollingController } from './TimedIntervalPollingController';
...
class ChildBlockTrackerPollingController extends TimedIntervalPollingController<PollingInput>()<
...
describe('StaticIntervalPollingController', () => {
  ...
  describe('stopPollingByPollingToken', () => {
    ...
    it('should stop polling session if it goes beyond the time', async () => {
      const input = {
        networkClientId: 'mainnet',
      };

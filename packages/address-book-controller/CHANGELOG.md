...
- **BREAKING:** The `addressBook` state property is now keyed by `Hex` chain ID rather than `string`, and the `chainId` property of each address book entry is also `Hex` rather than `string` ([#1385](https://github.com/MetaMask/core/pull/1385))
...
- Add optional `addressType` property to address book entries ([#828](https://github.com/MetaMask/core/pull/828), [#1068](https://github.com/MetaMask/core/pull/1068))

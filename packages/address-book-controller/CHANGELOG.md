...
- Bump `@metamask/controller-utils` from `^12.0.0` to `^12.3.0` ([#8774](https://github.com/MetaMask/core/pull/8774), [#9058](https://github.com/MetaMask/core/pull/9058), [#9083](https://github.com/MetaMask/core/pull/9083))
- Bump `@metamask/base-controller` from `^9.1.0` to `^9.1.1`
- Bump `@metamask/messenger` from `^1.2.0` to `^1.2.1`

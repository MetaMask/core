...
## [2.0.0]
### Changed
- **BREAKING:** Add `addressType` flag to address book entries ([#828](https://github.com/MetaMask/controllers/pull/828))
  - Each existing address entry will need to be updated to set the `addressType` field to `AddressType.unknown`.
...
[2.0.0]: https://github.com/MetaMask/core/compare/@metamask/address-book-controller@1.0.1...@metamask/address-book-controller@2.0.0

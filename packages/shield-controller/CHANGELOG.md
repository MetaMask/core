...
- Bump `@metamask/transaction-controller` from `^62.5.0` to `^62.8.0` ([#7430](https://github.com/MetaMask/core/pull/7430), [#7494](https://github.com/MetaMask/core/pull/7494))

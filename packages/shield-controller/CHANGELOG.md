...
- Bump `@metamask/transaction-controller` from `^62.9.2` to `^62.10.0` ([#7642](https://github.com/MetaMask/core/pull/7642), [#7737](https://github.com/MetaMask/core/pull/7737))

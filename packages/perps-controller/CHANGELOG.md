...
- **BREAKING:** `toggleWatchlistMarket` return type changed from `void` to `Promise<void>` to allow callers to await the remote write ([#9010](https://github.com/MetaMask/core/pull/9010))

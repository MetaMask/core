...
- `adaptOrderToSDK` now throws `ORDER_TRIGGER_PRICE_REQUIRED` when a trigger placement has no trigger price, where it previously never threw ([#9674](https://github.com/MetaMask/core/pull/9674))

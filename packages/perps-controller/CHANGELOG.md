...
- Add `updateDepositFromAddress` method and messenger action to update the `from` address on a pending deposit transaction when the user selects a different sub-account ([#9070](https://github.com/MetaMask/core/pull/9070))
- Export `SubAccountInfo` type from the package root ([#9070](https://github.com/MetaMask/core/pull/9070))

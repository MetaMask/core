...
- feat: expose 'runMigrations' to the messenger actions ([#9031](https://github.com/MetaMask/core/pull/9031))
- Release 1023.0.0 ([#9024](https://github.com/MetaMask/core/pull/9024))
- Release 1022.0.0 ([#9027](https://github.com/MetaMask/core/pull/9027))
- ci: Add top-level permissions to `publish-release` workflow ([#9026](https://github.com/MetaMask/core/pull/9026))
...
- Release 1022.0.0 ([#9021](https://github.com/MetaMask/core/pull/9021))
- fix: clear analytics queue on callback errors ([#8934](https://github.com/MetaMask/core/pull/8934))
- chore: Bump Yarn to `4.16.0` ([#9020](https://github.com/MetaMask/core/pull/9020))
...
- feat!: Use `RemoteFeatureFlagController` for `isRpcFailoverEnabled` ([#9013](https://github.com/MetaMask/core/pull/9013))
- Release/1022.0.0 ([#9015](https://github.com/MetaMask/core/pull/9015))
- feat: adding support for postQuote transactions with paymentOverride defined ([#8967](https://github.com/MetaMask/core/pull/8967))
- refactor(transaction-controller): remove deprecated constructor options and unused hooks ([#8983](https://github.com/MetaMask/core/pull/8983))
- fix: Update network nicknames and block explorer URLs ([#9005](https://github.com/MetaMask/core/pull/9005))
- feat(profile-metrics-controller): add proof of ownership API pre-requisites ([#8974](https://github.com/MetaMask/core/pull/8974))
- fix(profile-sync-controller): deduplicate identical pairing calls ([#8984](https://github.com/MetaMask/core/pull/8984))
- ci: Enable NPM publishing with OIDC ([#8998](https://github.com/MetaMask/core/pull/8998))
- feat: enhance fiat quote submission to support canonical provider cod… ([#9004](https://github.com/MetaMask/core/pull/9004))
- feat: Add defaults for policy and block tracker options ([#9002](https://github.com/MetaMask/core/pull/9002))
- Release/1021.0.0 ([#9003](https://github.com/MetaMask/core/pull/9003))
- Release/1020.0.0 ([#8999](https://github.com/MetaMask/core/pull/8999))
- fix: Add proper defaults for `RpcServiceOptions` ([#9000](https://github.com/MetaMask/core/pull/9000))
- feat: add flag to exclude networks from using infura for live balance ([#8992](https://github.com/MetaMask/core/pull/8992))
- feat: add ARC and TEMPO to popular networks in ne ctrl ([#8997](https://github.com/MetaMask/core/pull/8997))
- feat(accounts-controller)!: use new `SnapAccountService` account data events ([#8978](https://github.com/MetaMask/core/pull/8978))
- Initialize Wallet Framework documentation ([#8927](https://github.com/MetaMask/core/pull/8927))
- ci: Check that root package is bumped for release pull requests ([#8991](https://github.com/MetaMask/core/pull/8991))
- Release/1019.0.0 ([#8990](https://github.com/MetaMask/core/pull/8990))
- feat: add bearer token authorization to RampsService payments & quotes ([#8888](https://github.com/MetaMask/core/pull/8888))
- fix: transaction parameters for batch swap transactions ([#8979](https://github.com/MetaMask/core/pull/8979))
- Release/1018.0.0 ([#8989](https://github.com/MetaMask/core/pull/8989))
- fix: map non-prefixed payment method IDs in Transak translation ([#8980](https://github.com/MetaMask/core/pull/8980))
- feat: disable token list ([#8945](https://github.com/MetaMask/core/pull/8945))
- Release/1017.0.0 ([#8986](https://github.com/MetaMask/core/pull/8986))
- Release/1017.0.0 ([#8985](https://github.com/MetaMask/core/pull/8985))
- fix: normalize balances ([#8982](https://github.com/MetaMask/core/pull/8982))
- fix: Normalize remote feature flag value wrappers ([#8908](https://github.com/MetaMask/core/pull/8908))
- fix(profile-sync-controller): scope storage-key & snap-signature caches by `entropySourceId` ([#8948](https://github.com/MetaMask/core/pull/8948))
- Release/1016.0.0 ([#8981](https://github.com/MetaMask/core/pull/8981))
- feat: add ARC mainnet to asset controller ([#8973](https://github.com/MetaMask/core/pull/8973))
- refactor(wallet): migrate keyring + storage instances to directory convention ([#8977](https://github.com/MetaMask/core/pull/8977))
- feat(snap-account-service): always forward non-keyring events in `:handleKeyringSnapMessage` ([#8916](https://github.com/MetaMask/core/pull/8916))
- refactor(snap-account-service)!: make init sync + use it in ctor ([#8877](https://github.com/MetaMask/core/pull/8877))
- fix(snap-account-service): faster `:getLegacySnapKeyring` ([#8865](https://github.com/MetaMask/core/pull/8865))
- fix(snap-account-service)!: relax keyring messages/methods handling ([#8860](https://github.com/MetaMask/core/pull/8860))
- feat(wallet): wire `ApprovalController` into default initialization ([#8953](https://github.com/MetaMask/core/pull/8953))
- Release 1015.0.0 ([#8976](https://github.com/MetaMask/core/pull/8976))
- feat!: set `assets.native.coingeckoCoinId` as optional ([#8970](https://github.com/MetaMask/core/pull/8970))
- chore(transaction-pay-controller): declare @metamask/keyring-controller as a dependency ([#8972](https://github.com/MetaMask/core/pull/8972))
- chore(react-data-query): declare @metamask/messenger as a devDep ([#8971](https://github.com/MetaMask/core/pull/8971))
- Release 1014.0.0 ([#8968](https://github.com/MetaMask/core/pull/8968))
- Release 1013.0.0 ([#8966](https://github.com/MetaMask/core/pull/8966))
- refactor(transaction-pay-controller): use `autoSelectProvider` and `restrictToKnownOrNativeProviders` in fiat quotes ([#8963](https://github.com/MetaMask/core/pull/8963))
- feat(wallet): forward `keyringV2Builders` to `KeyringController` ([#8956](https://github.com/MetaMask/core/pull/8956))
- feat: add provider auto-selection to RampsController.getQuotes ([#8949](https://github.com/MetaMask/core/pull/8949))
- Release 1012.0.0 ([#8954](https://github.com/MetaMask/core/pull/8954))
- feat(wallet)!: Add `StorageService` initialization ([#8946](https://github.com/MetaMask/core/pull/8946))
- ci: Get access token in each job individually in `update-changelogs` workflow ([#8959](https://github.com/MetaMask/core/pull/8959))
- feat(wallet): export `importSecretRecoveryPhrase` from package root ([#8952](https://github.com/MetaMask/core/pull/8952))
- ci: Add missing OIDC permissions ([#8958](https://github.com/MetaMask/core/pull/8958))
- fix(keyring-controller): auto-remove keyrings emptied during `withKeyring` callbacks ([#8951](https://github.com/MetaMask/core/pull/8951))
- ci: Replace Patroll tokens with `get-token` action ([#8932](https://github.com/MetaMask/core/pull/8932))
- chore: Update `GeolocationController` CODEOWNER ([#8950](https://github.com/MetaMask/core/pull/8950))
- Release 1011.0.0 ([#8947](https://github.com/MetaMask/core/pull/8947))
- Release/1010.0.0 ([#8943](https://github.com/MetaMask/core/pull/8943))
- fix(transaction-pay-controller): use Infura endpoint for live token balance queries ([#8839](https://github.com/MetaMask/core/pull/8839))

### Changed

- Reclassify `xyz:CBRS` (Cerebras) from `stock` to `pre-ipo` and add `xyz:IPOP` (Quantinuum) as `pre-ipo` in `HIP3_ASSET_MARKET_TYPES`, so all three Pre-IPO Perpetual markets on trade.xyz (CBRS, SPCX, IPOP) display under the Pre-IPO category

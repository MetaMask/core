...
export class HyperLiquidWalletService {
  ...
  /**
   * Creates a new HyperLiquidWalletService instance.
   *
   * @param deps - Platform dependencies for account access and signing
   ...
   *
   * @returns Wallet adapter object with address, signTypedData, and getChainId
   */
   ...
   *
   * @returns The current account ID in CAIP-10 format
   */
   ...
   *
   * @param accountId - The CAIP-10 account ID
   ...
   *
   * @param accountId - Optional CAIP-10 account ID
   * @returns The validated Hex address
   */

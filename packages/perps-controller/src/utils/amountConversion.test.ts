...
describe('convertPerpsAmountToUSD', () => {
  ...
  it('handles hex wei values correctly', () => {
    // 1 ETH in wei (0xde0b6b3a7640000) with placeholder ETH price of $2000
  ...
  it('handles very small amounts', () => {
    // Very small wei amount - rounds to $0 after conversion
    expect(convertPerpsAmountToUSD('0x1')).toBe('< $0.01');

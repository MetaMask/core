...
/**
 * State interface for service state management.
 * Uses generic state shape to decouple from specific PerpsControllerState definition.
 */
type ServiceState = {
...
export type ServiceContext = {
   ...
   */
  stateManager?: {
    update: (updater: (state: ServiceState) => void) => void;

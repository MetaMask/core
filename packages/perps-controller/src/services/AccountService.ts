...
export class AccountService {
   ...
   * @param options.params - Withdrawal parameters
   * @param options.context - Service context with state manager and tracing
   * @param options.refreshAccountState - Callback to refresh account state
   * @returns Promise resolving to WithdrawResult
   */
   ...
   * @param options.provider - The perps provider instance
   * @param options.params - Withdrawal parameters to validate

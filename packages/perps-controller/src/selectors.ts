...
// Note: createSelector functions below use eslint-disable comments because Core's
// jsdoc rules require documentation for all input selector functions, which would
// add noise to these utility selectors. Mobile does not have this ESLint rule.

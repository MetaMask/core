/* eslint-disable no-restricted-syntax, @typescript-eslint/naming-convention, jsdoc/require-param, jsdoc/check-param-names, jsdoc/require-returns */
...
export class AggregatedPerpsProvider implements PerpsProvider {
  ...
  /**
   * Create a new AggregatedPerpsProvider.
   *
   * @param config - Configuration for the aggregated provider
   */
   ...
   *
   * @returns Array of provider tuples
   */
   ...
   * @returns Tuple of [providerId, provider]
   */
  ...
  /**
   * Get deposit routes from default provider.
   *
  ...
  /**
   * Get withdrawal routes from default provider.
   *
   * @param params - Optional parameters
   * @returns Array of asset routes
   */
   ...
   *
   * @param params - Optional parameters
   * @returns Aggregated positions with providerId
   */
  ...
  /**
   * Get account state from default provider.
   *
   * @param params - Optional parameters
   * @returns Account state with providerId
   */
   ...
   *
   * @param params - Optional parameters
   * @returns Deduplicated markets with providerId
   */
  ...
  /**
   * Get market data with prices from all providers.
   *
   * @returns Aggregated market data with providerId
   */
  ...
  /**
   * Get order fills from all providers.
   *
   * @param params - Optional parameters
   * @returns Aggregated order fills with providerId
   */
  ...
  /**
   * Get orders from all providers.
   *
   * @param params - Optional parameters
   * @returns Aggregated orders with providerId
   */
  ...
  /**
   * Get open orders from all providers.
   *
   * @param params - Optional parameters
   * @returns Aggregated open orders with providerId
   */
  ...
  /**
   * Get funding from all providers.
   *
   * @param params - Optional parameters
  ...
  /**
   * Get historical portfolio from default provider.
   *
   * @param params - Optional parameters
  ...
  /**
   * Place an order via routed provider.
   *
   * @param params - Order parameters
   * @returns Order result with providerId
   */
  ...
  /**
   * Edit an order via routed provider.
   *
   * @param params - Edit order parameters
   * @returns Order result with providerId
   */
  ...
  /**
   * Cancel an order via routed provider.
   *
   * @param params - Cancel order parameters
   * @returns Cancel result with providerId
   */
  ...
  /**
   * Cancel multiple orders via default provider.
   *
   * @param params - Batch cancel parameters
   * @returns Batch cancel result
   */
  async cancelOrders(
  ...
  /**
   * Close a position via routed provider.
   *
  ...
  /**
   * Close multiple positions via default provider.
   *
   * @param params - Close positions parameters
   * @returns Batch close result
   */
  ...
  /**
   * Update position TP/SL via routed provider.
   *
   * @param params - Update TP/SL parameters
   * @returns Order result with providerId
   */
  ...
  /**
   * Update margin via routed provider.
   *
   * @param params - Update margin parameters
   * @returns Margin result
   */
  ...
  /**
   * Validate deposit via default provider.
   *
  ...
  /**
   * Validate order via routed provider.
   *
   * @param params - Order parameters
   * @returns Validation result
   */
  ...
  /**
   * Validate close position via routed provider.
   *
   * @param params - Close position parameters
   * @returns Validation result
   */
  ...
  /**
   * Validate withdrawal via routed provider.
   *
   * @param params - Withdraw parameters
   * @returns Validation result
   */
  ...
  /**
   * Calculate liquidation price via default provider.
   *
   * @param params - Liquidation price parameters
  ...
  /**
   * Calculate maintenance margin via default provider.
   *
   * @param params - Maintenance margin parameters
  ...
  /**
   * Get max leverage for asset via default provider.
   *
   * @param asset - Asset symbol
   * @returns Max leverage as number
   */
  ...
  /**
   * Calculate fees via default provider.
   *
  ...
  /**
   * Subscribe to prices from all providers.
   *
  ...
  /**
   * Subscribe to positions from all providers.
   *
   * @param params - Subscription parameters
   * @returns Unsubscribe function
   */
  ...
  /**
   * Subscribe to order fills from all providers.
   *
   * @param params - Subscription parameters
   * @returns Unsubscribe function
   */
  ...
  /**
   * Subscribe to orders from all providers.
   *
   * @param params - Subscription parameters
   * @returns Unsubscribe function
   */
  ...
  /**
   * Subscribe to account from default provider.
   *
   * @param params - Subscription parameters
   * @returns Unsubscribe function
   */
  ...
  /**
   * Subscribe to OI caps from default provider.
   *
   * @param params - Subscription parameters
   * @returns Unsubscribe function
   */
  ...
  /**
   * Subscribe to candles from default provider.
   *
   * @param params - Subscription parameters
   * @returns Unsubscribe function
   */
  ...
  /**
   * Subscribe to order book from default provider.
   *
   * @param params - Subscription parameters
   * @returns Unsubscribe function
   */
  ...
  /**
   * Set live data config on all providers.
   *
   * @param config - Partial live data config
   */
  ...
  /**
   * Set user fee discount on all providers.
   *
   * @param discountBips - Discount in basis points
   */
  ...
  /**
   * Toggle testnet on default provider.
   *
  ...
  /**
   * Check if ready to trade via default provider.
   *
   * @returns Ready to trade result
   */
  ...
  /**
   * Get block explorer URL from default provider.
   *
  ...
  /**
   * Get available DEXs from default provider.
   *
   * @param params - Optional parameters

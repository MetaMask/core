...
export class ProviderRouter {
  ...
  private readonly strategy: RoutingStrategy = 'default_provider';

  /** Map of provider ID to the markets it supports */
  private readonly providerMarkets: Map<PerpsProviderType, Set<string>> =
    new Map();
   ...
   * @param options.defaultProvider - Default provider for operations without explicit providerId
   * @param options.strategy - Routing strategy (Phase 1: only 'default_provider' supported)
   */
  constructor(options: {

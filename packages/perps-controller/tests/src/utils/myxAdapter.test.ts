...
jest.mock('@myx-trade/sdk', () => ({
  ...
  OrderStatus: {},
  TimeInForce: {},
  DirectionEnum: { Long: 0, Short: 1 },
  OrderTypeEnum: { Market: 0, Limit: 1, Stop: 2, Conditional: 3 },
  OperationEnum: { Increase: 0, Decrease: 1 },
  OrderStatusEnum: { Cancelled: 1, Expired: 2, Successful: 9 },
  ExecTypeEnum: {
    Market: 1,
    Limit: 2,
    TP: 3,

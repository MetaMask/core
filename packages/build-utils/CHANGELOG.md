...
- Bump `eslint` to `^9.11.1` and migrate to flat config ([#4727](https://github.com/MetaMask/core.git/pull/4727))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/build-utils@3.0.2...HEAD

...
- Added `orders` array to controller state for storing V2 orders with persistence, plus add/update/remove methods ([#8045](https://github.com/MetaMask/core/pull/8045))

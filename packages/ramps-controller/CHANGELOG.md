...
- Stop persisting `providers` and `tokens` state across sessions to prevent stale data when API availability changes ([#8305](https://github.com/MetaMask/core/pull/8305))

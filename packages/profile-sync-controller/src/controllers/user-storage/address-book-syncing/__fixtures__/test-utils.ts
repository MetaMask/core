...
import { MOCK_LOCAL_CONTACTS, MOCK_REMOTE_CONTACTS } from './mockContacts';
 ...
 */
export function mockUserStorageMessengerForAddressBookSyncing(
  options?: {
    addressBook?: {
  ...
  const messenger = {
    ...
    clearEventSubscriptions: baseMessenger.clearEventSubscriptions.bind(baseMessenger),
...
export const createMockUserStorageContacts = async (contacts: any) => {

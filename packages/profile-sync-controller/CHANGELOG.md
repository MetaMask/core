...
- Add social identifier pairing after SRP sign-in (`POST /api/v2/profile/pair/identifier`) ([#10128](https://github.com/MetaMask/core/pull/10128))
  ...
  - Allow `SeedlessOnboardingController:getAccessToken` so the controller can fetch the social JWT (refreshed when expired).

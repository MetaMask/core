...
- refactor!: `addNewKeyring` returns metadata instead of keyring ([#5372](https://github.com/MetaMask/core.git/pull/5372))
- refactor: rename profile-sync exported `__fixtures__` folder to `mocks` ([#5381](https://github.com/MetaMask/core.git/pull/5381))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/profile-sync-controller@8.1.1...HEAD

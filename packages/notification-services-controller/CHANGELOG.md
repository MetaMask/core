...
- feat: add support for locales on push notifications ([#5392](https://github.com/MetaMask/core.git/pull/5392))
- refactor: rename notification exported `__fixtures__` folder to `mocks` ([#5379](https://github.com/MetaMask/core.git/pull/5379))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/notification-services-controller@1.0.0...HEAD

...
- Release 326.0.0 ([#5479](https://github.com/MetaMask/core.git/pull/5479))
- fix: add support for fetching shared announcements cross platforms ([#5441](https://github.com/MetaMask/core.git/pull/5441))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/notification-services-controller@3.0.0...HEAD

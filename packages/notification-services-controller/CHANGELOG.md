...
- **BREAKING:** Bump `@metamask/profile-sync-controller` peer dependency from `^7.0.1` to `^8.0.0` ([#5318](https://github.com/MetaMask/core/pull/5318))
...
[0.21.0]: https://github.com/MetaMask/core/compare/@metamask/notification-services-controller@0.21.0...@metamask/notification-services-controller@1.0.0

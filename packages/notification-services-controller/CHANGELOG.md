...
- feat: optimise push controller API calls ([#5358](https://github.com/MetaMask/core.git/pull/5358))
...
- fix: only allow hex addresses when creating notifications ([#5343](https://github.com/MetaMask/core.git/pull/5343))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/notification-services-controller@0.21.0...HEAD

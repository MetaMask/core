...
- Fix ESLint violations by adding explicit return types to `isVersionInBounds` and `shouldAutoExpire` utility functions ([#7478](https://github.com/MetaMask/core/pull/7478))

  ...
  const rawNotifications = contentfulNotifications.map((n) => {
    ...
    const notification = {
      ...
      data: {
        ...
        title: fields.title,
        longDescription: _richtexthtmlrenderer.documentToHtmlString.call(void 0, fields.longDescription),
...
async function getFeatureAnnouncementNotifications(env) {
  if (env?.accessToken && env?.spaceId && env?.platform) {
    ...
    const notifications = rawNotifications.map(
      (notification) => _chunk52CALMRAjs.processFeatureAnnouncement.call(void 0, notification)
    );
...
exports.FEATURE_ANNOUNCEMENT_API = FEATURE_ANNOUNCEMENT_API; exports.FEATURE_ANNOUNCEMENT_URL = FEATURE_ANNOUNCEMENT_URL; exports.getFeatureAnnouncementNotifications = getFeatureAnnouncementNotifications;
//# sourceMappingURL=chunk-HZEB53A6.js.map
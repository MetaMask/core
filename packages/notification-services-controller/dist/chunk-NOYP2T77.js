...
function initializeUserStorage(accounts, state) {
  ...
  accounts.forEach((account) => {
    ...
    Object.entries(_chunkV6P5JEPTjs.TRIGGERS).forEach(
...
function isAccountEnabled(accountAddress, userStorage) {
  ...
  for (const [triggerKind, triggerConfig] of Object.entries(_chunkV6P5JEPTjs.TRIGGERS)) {

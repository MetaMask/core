...
- Add optional `overrideFeatureFlags` constructor option for client-side feature flags that take precedence over defaults, processed remote flags, and persisted local overrides.

...
- fix(5383): flaky user-segmentation-utils distribution test fix ([#5384](https://github.com/MetaMask/core.git/pull/5384))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/remote-feature-flag-controller@1.5.0...HEAD

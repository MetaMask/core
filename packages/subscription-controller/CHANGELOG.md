...
- Bump `@metamask/transaction-controller` from `^69.6.1` to `^69.9.0` ([#10046](https://github.com/MetaMask/core/pull/10046), [#10080](https://github.com/MetaMask/core/pull/10080))

...
- Bump `@metamask/transaction-controller` from `^61.3.0` to `^62.0.0` ([#7153](https://github.com/MetaMask/core/pull/7153), [#7190](https://github.com/MetaMask/core/pull/7190))

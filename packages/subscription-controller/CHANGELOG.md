...
- Bump `@metamask/transaction-controller` from `^64.0.0` to `^64.1.1` ([#8432](https://github.com/MetaMask/core/pull/8432), [#8447](https://github.com/MetaMask/core/pull/8447))

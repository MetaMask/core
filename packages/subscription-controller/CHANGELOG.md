...
- Bump `@metamask/transaction-controller` from `^62.0.0` to `^62.2.0` ([#7215](https://github.com/MetaMask/core/pull/7215), [#7219](https://github.com/MetaMask/core/pull/7219))

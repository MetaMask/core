...
## [0.1.2]
### Uncategorized
- use network confiurations always ([#1962](https://github.com/MetaMask/core.git/pull/1962))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/queued-request-controller@0.1.2...HEAD

...
- **BREAKING:** Bump peer dependency `@metamask/selected-network-controller` to `^14.0.0` ([#4374](https://github.com/MetaMask/core/pull/4374))
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/queued-request-controller@0.13.0...HEAD
[0.13.0]: https://github.com/MetaMask/core/compare/@metamask/queued-request-controller@0.12.0...@metamask/queued-request-controller@0.13.0

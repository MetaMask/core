...
- Add Bitcoin network to `init()` method for automatic enablement when configured in MultichainNetworkController ([#6441](https://github.com/MetaMask/core/pull/6441))

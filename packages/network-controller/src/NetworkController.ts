...
> {
   ...
   * opted in to analytics. This call throws while the wallet is locked, and in
   * clients that register no `AuthenticationController`. In both cases the
   * request is made without the credential.
   *

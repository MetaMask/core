...
- Fix unmocked block tracker warning in NetworkController tests ([#5289](https://github.com/MetaMask/core.git/pull/5289))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/network-controller@23.5.0...HEAD

...
- fix: throw error when removing selected network ([#4566](https://github.com/MetaMask/core.git/pull/4566))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/network-controller@20.1.0...HEAD

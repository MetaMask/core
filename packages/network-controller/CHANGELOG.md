...
- chore(network-controller): replace `Sinon` with `Jest` fake timers ([#7986](https://github.com/MetaMask/core/pull/7986))
- chore(ramps-controller): replace Sinon with Jest fake timers ([#7973](https://github.com/MetaMask/core/pull/7973))
...
- fix: Preserve `data.cause` when deserializing ([#7838](https://github.com/MetaMask/core/pull/7838))
...
- chore(lint): Fix suppressed ESLint errors in `network-controller` package ([#7445](https://github.com/MetaMask/core/pull/7445))
...
- network-controller: Mention addition of degraded status in changelog ([#7293](https://github.com/MetaMask/core/pull/7293))
...
- Revert "fix(rpc-service): improve error handling for HTTP status codes (#5843) ([#5843](https://github.com/MetaMask/core/pull/5843))
- fix(rpc-service): improve error handling for HTTP status codes ([#5843](https://github.com/MetaMask/core/pull/5843))
...
- Add ability to create RPC service chain ([#5226](https://github.com/MetaMask/core/pull/5226))
- chore(network): Rename `ControllerMessenger` to `Messenger` ([#5241](https://github.com/MetaMask/core/pull/5241))
- Include endpointUrl in RpcService event listener data ([#5225](https://github.com/MetaMask/core/pull/5225))
- Add failover support to RpcService ([#5202](https://github.com/MetaMask/core/pull/5202))
- NetworkController: Add RPC service class ([#5163](https://github.com/MetaMask/core/pull/5163))
...
- Release 228.0.0 ([#4841](https://github.com/MetaMask/core/pull/4841))
...
- Adapt to eip 1193 provider changes ([#4442](https://github.com/MetaMask/core/pull/4442))
...
- Fully remove `eth_sign` ([#4319](https://github.com/MetaMask/core/pull/4319))
...
- Remove `as` assertion casting `FakeBlockTracer` to `BlockTracker` ([#1833](https://github.com/MetaMask/core/pull/1833))
...
- Bump @metamask/eth-json-rpc-middleware from 11.0.1 to 11.0.2 ([#1661](https://github.com/MetaMask/core/pull/1661))
...
- Release 71.0.0 ([#1584](https://github.com/MetaMask/core/pull/1584))
- Release 70.0.0 ([#1572](https://github.com/MetaMask/core/pull/1572))
...
- Release 66.0.0 ([#1488](https://github.com/MetaMask/core/pull/1488))
- feat: add linea networks support ([#1423](https://github.com/MetaMask/core/pull/1423))
- Release 64.0.0 ([#1470](https://github.com/MetaMask/core/pull/1470))
- Rewrite network configuration management tests ([#1454](https://github.com/MetaMask/core/pull/1454))
- Release 59.0.0 ([#1448](https://github.com/MetaMask/core/pull/1448))
- Release 56.0.0 ([#1426](https://github.com/MetaMask/core/pull/1426))
- Fix tests for NetworkController getEIP1559Compatibility ([#1420](https://github.com/MetaMask/core/pull/1420))
- Add missing upsertNetworkConfiguration test ([#1413](https://github.com/MetaMask/core/pull/1413))
- Add runtime checks to NC setProviderType ([#1414](https://github.com/MetaMask/core/pull/1414))
- Add missing tests for getEIP1559Compatibility ([#1410](https://github.com/MetaMask/core/pull/1410))
- Add missing tests for getProviderAndBlockTracker ([#1409](https://github.com/MetaMask/core/pull/1409))
- Improve test for NC getEthQuery action ([#1411](https://github.com/MetaMask/core/pull/1411))
- Release 55.0.0 ([#1408](https://github.com/MetaMask/core/pull/1408))
- Add missing test for NC setActiveNetwork method ([#1407](https://github.com/MetaMask/core/pull/1407))
- Remove fake timers from NetworkController tests ([#1399](https://github.com/MetaMask/core/pull/1399))
- Use Jest snapshots for testing initial NetworkController state ([#1397](https://github.com/MetaMask/core/pull/1397))
- Release 53.0.0 ([#1385](https://github.com/MetaMask/core/pull/1385))
- Add missing tests for setProviderType and setActiveNetwork ([#1391](https://github.com/MetaMask/core/pull/1391))
- Sync NetworkController constructor tests w/ extension ([#1383](https://github.com/MetaMask/core/pull/1383))
- Sync NetworkController.destroy tests w/ extension ([#1382](https://github.com/MetaMask/core/pull/1382))
- Improve NetworkController.initializeProvider tests ([#1392](https://github.com/MetaMask/core/pull/1392))
- Sync network controller tests with extension (part 1) ([#1381](https://github.com/MetaMask/core/pull/1381))
...
- Simplify `setProviderType` unit tests ([#1222](https://github.com/MetaMask/core/pull/1222))
- Consolidate `setProviderType` unit tests ([#1221](https://github.com/MetaMask/core/pull/1221))
- Eliminate console error when running test ([#1179](https://github.com/MetaMask/core/pull/1179))
- Fix test description ([#1175](https://github.com/MetaMask/core/pull/1175))
- Release 45.0.0 ([#1165](https://github.com/MetaMask/core/pull/1165))
- Release 44.0.0 ([#1148](https://github.com/MetaMask/core/pull/1148))
- Fix/web3 middleware testing ([#1087](https://github.com/MetaMask/core/pull/1087))
- Release 42.0.0 ([#1108](https://github.com/MetaMask/core/pull/1108))
- Remove EthQuery.sendAsync check from NetworkController ([#1094](https://github.com/MetaMask/core/pull/1094))

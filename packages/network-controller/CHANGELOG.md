...
- Integrate RPC failover into NetworkController ([#5360](https://github.com/MetaMask/core.git/pull/5360))
- feat: add `signEip7702Authorization` to `KeyringController` ([#5301](https://github.com/MetaMask/core.git/pull/5301))
- RpcService: Regard node-fetch errors as retriable ([#5298](https://github.com/MetaMask/core.git/pull/5298))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/network-controller@22.2.1...HEAD

...
- fix: Network controller race condition after state update ([#5122](https://github.com/MetaMask/core.git/pull/5122))
- Fix ESLint config ([#5132](https://github.com/MetaMask/core.git/pull/5132))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/network-controller@22.1.1...HEAD

...
- chore(deps): bump @metamask/eth-json-rpc-middleware from 12.0.1 to 12.1.0 ([#3829](https://github.com/MetaMask/core.git/pull/3829))
...
[Unreleased]: https://github.com/MetaMask/core.git/compare/@metamask/network-controller@17.2.0...HEAD

...
### Changed
- **BREAKING:** Add property `chainId` to `InfuraNetworkClientConfiguration` ([#1571](https://github.com/MetaMask/core/pull/1571))
...
[13.0.0]: https://github.com/MetaMask/core/compare/@metamask/network-controller@12.0.0...@metamask/network-controller@13.0.0

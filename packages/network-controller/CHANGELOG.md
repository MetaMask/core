...
- Improved handling of HTTP status codes to prevent unnecessary circuit breaker triggers ([#5798](https://github.com/MetaMask/core/pull/5798), [#5807](https://github.com/MetaMask/core/pull/5807))
  ...
  - 500-599 (Server Errors) now throw JSON-RPC error with code -32002 (Resource unavailable) instead of internal error
  - 402 and 404 responses are consolidated with 5XX handling, all using resource unavailable error type

...
const defaultState = {
    ...
    provider: { type: controller_utils_1.MAINNET, chainId: controller_utils_1.NetworksChainId.mainnet },
...
class NetworkController extends base_controller_1.BaseControllerV2 {
    ...
    getIsCustomNetwork(chainId) {
        return (chainId !== controller_utils_1.NetworksChainId.mainnet &&
            chainId !== controller_utils_1.NetworksChainId.kovan &&
            chainId !== controller_utils_1.NetworksChainId.rinkeby &&
            chainId !== controller_utils_1.NetworksChainId.goerli &&
            chainId !== controller_utils_1.NetworksChainId.ropsten &&
    ...
    setProviderType(type) {
        ...
        this.update((state) => {
            ...
            state.provider.chainId = controller_utils_1.NetworksChainId[type];
    ...
    setRpcTarget(rpcTarget, chainId, ticker, nickname) {
        this.update((state) => {
            state.provider.type = controller_utils_1.RPC;

...
## [Unreleased]
### Uncategorized
- Add expire limit for proposed names ([#3748](https://github.com/MetaMask/core/pull/3748))
...
[Unreleased]: https://github.com/MetaMask/core/compare/@metamask/name-controller@4.2.0...HEAD

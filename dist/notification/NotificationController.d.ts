...
export declare type ControllerActions = GetNotificationControllerState | ShowNotification | DismissNotification | MarkNotificationRead;
export declare type NotificationControllerMessenger = RestrictedControllerMessenger<typeof name, ControllerActions, NotificationControllerStateChange, never, never>;
/**

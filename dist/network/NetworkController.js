 ...
 */
class NetworkController extends BaseControllerV2_1.BaseController {
    ...
    lookupNetwork() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.ethQuery.sendAsync({ method: 'net_version' }, (error, network) => {
                ...
                this.messagingSystem.publish(`NetworkController:providerChange`, this.state.provider);
                releaseLock();
            });
        });
    }
    ...
    setRpcTarget(rpcTarget, chainId, ticker, nickname) {
        this.update((state) => {
            state.provider.type = constants_1.RPC;

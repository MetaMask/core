...
exports.fetchTokenMetadata = exports.fetchTokenList = exports.FETCH_TOKEN_METADATA_ERROR = void 0;
const util_1 = require("../util");
const END_POINT = 'https://token-api.metaswap.codefi.network';
exports.FETCH_TOKEN_METADATA_ERROR = 'TokenService Error: No response from fetchTokenMetadata';
/**
...
function fetchTokenMetadata(chainId, tokenAddress, abortSignal, { timeout = defaultTimeout } = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        throw new Error(exports.FETCH_TOKEN_METADATA_ERROR);
    });
}

...
const getIncreasedPriceFromExisting = (value, rate) => {
    return (0, exports.getIncreasedPriceHex)((0, exports.convertPriceToDecimal)(value), rate);
};
...
function validateMinimumIncrease(proposed, min) {
    const proposedDecimal = (0, exports.convertPriceToDecimal)(proposed);
    const minDecimal = (0, exports.convertPriceToDecimal)(min);

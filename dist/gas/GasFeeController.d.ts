...
import type { NetworkControllerGetEthQueryAction, NetworkControllerGetProviderConfigAction, NetworkControllerProviderChangeEvent, NetworkController, NetworkState } from '../network/NetworkController';

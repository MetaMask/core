...
function calculateEstimatesForPriorityLevel(priorityLevel, blocks) {
    ...
    return Object.assign(Object.assign({}, settings.estimatedWaitTimes), { suggestedMaxPriorityFeePerGas: ethjs_unit_1.fromWei(suggestedMaxPriorityFeePerGas, 'gwei'), suggestedMaxFeePerGas: ethjs_unit_1.fromWei(suggestedMaxFeePerGas, 'gwei') });
}
/**

...
class KeyringController extends BaseController_1.BaseController {
    ...
    signTypedMessage(messageParams, version) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const isLedgerAccount = yield ledgerKeyring.managesAccount(address);
                if (isLedgerAccount) {
                    return __classPrivateFieldGet(this, _KeyringController_keyring, "f").signTypedMessage(messageParams, { version });
                }
    ...
    unlockLedgerDefaultAccount() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newAccounts = yield __classPrivateFieldGet(this, _KeyringController_keyring, "f").getAccounts();
            this.updateIdentities(newAccounts);
            newAccounts.forEach((address, index) => {
                if (!oldAccounts.includes(address)) {
                    if (this.setAccountLabel) {

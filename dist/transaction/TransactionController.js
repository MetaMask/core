...
class TransactionController extends BaseController_1.BaseController {
    ...
    estimateGas(transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                gasHex = yield (0, util_1.query)(this.ethQuery, 'estimateGas', [
                    estimatedTransaction,
                ]);
            }
            catch (error) {
                estimateGasError = constants_1.ESTIMATE_GAS_ERROR;
            }
            ...
            if (paddedGasBN.lt(maxGasBN)) {
                return {
                    gas: (0, ethereumjs_util_1.addHexPrefix)((0, util_1.BNToHex)(paddedGasBN)),
                    gasPrice,
                    estimateGasError,
                };
            }

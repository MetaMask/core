...
class CollectiblesController extends BaseController_1.BaseController {
    ...
    getCollectibleInformationFromApi(contractAddress, tokenId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { num_sales, background_color, image_url, image_preview_url, image_thumbnail_url, image_original_url, animation_url, animation_original_url, name, description, external_link, creator, last_sale, asset_contract: { schema_name }, collection, } = collectibleInformation;
            ...
            }, external_link && { externalLink: external_link }, last_sale && { lastSale: last_sale }, schema_name && { standard: schema_name }, collection.name && { collectionName: collection.name }, collection.image_url && { collectionImage: collection.image_url });
    ...
    addIndividualCollectible(address, tokenId, collectibleMetadata) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const existingEntry = collectibles.find((collectible) => assetsUtil_1.compareCollectibles(collectible, address, tokenId));
                if (existingEntry) {
                    ...
                    if (differentMetadata || typeof existingEntry.tokenId === 'number') {
                        ...
                        const indexToRemove = collectibles.findIndex((collectible) => assetsUtil_1.compareCollectibles(collectible, address, tokenId));
                        /* istanbul ignore next */
                        if (indexToRemove !== -1) {

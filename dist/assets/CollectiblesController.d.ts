...
declare enum SuggestedCollectibleStatus {
    accepted = "accepted",
    failed = "failed",
    pending = "pending",
    rejected = "rejected"
}
export declare type SuggestedCollectibleMetaBase = {
    id: string;
    time: number;
...
*/
export declare type SuggestedCollectibleMeta = (SuggestedCollectibleMetaBase & {
    status: SuggestedCollectibleStatus.failed;
    error: Error;
}) | (SuggestedCollectibleMetaBase & {
    status: SuggestedCollectibleStatus.accepted | SuggestedCollectibleStatus.rejected | SuggestedCollectibleStatus.pending;
});
/**
...
export declare class CollectiblesController extends BaseController<CollectiblesConfig, CollectiblesState> {
     ...
     */
    watchCollectible(collectible: Collectible): Promise<CollectibleSuggestionResult>;
    /**
     ...
     */
    acceptWatchCollectible(suggestedCollectibleID: string): Promise<void>;
    /**
     ...
     * @param suggestedCollectibleID - The ID of the suggestedCollectible to accept.
     */
    rejectWatchCollectible(suggestedCollectibleID: string): void;
}

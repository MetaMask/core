 ...
 */
export declare class CurrencyRateController extends BaseController<typeof name, CurrencyRateState> {
    private mutex;
    private intervalId?;
    ...
    constructor({ includeUsdRate, interval, messenger, state, fetchExchangeRate, }: {
        ...
        interval?: number;
        messenger: RestrictedControllerMessenger<typeof name, GetCurrencyRateState, CurrencyRateStateChange, never, never>;

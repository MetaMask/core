...
export declare type ControllerActions<RateLimitedApis extends Record<string, (...args: any[]) => any>> = GetRateLimitState<RateLimitedApis> | CallApi<RateLimitedApis>;
export declare type RateLimitMessenger<RateLimitedApis extends Record<string, (...args: any[]) => any>> = RestrictedControllerMessenger<typeof name, ControllerActions<RateLimitedApis>, RateLimitStateChange<RateLimitedApis>, never, never>;
/**

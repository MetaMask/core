...
linkStyle default opacity:0.5
  ...
  analytics_data_regulation_controller --> utils;
  ...
  assets_controller --> authenticated_user_storage;
  ...
  config_registry_controller --> utils;
  ...
  eip1193_permission_middleware --> utils;
  eth_block_tracker --> eth_json_rpc_provider;
  eth_block_tracker --> utils;
  ...
  gator_permissions_controller --> utils;
  ...
  json_rpc_middleware_stream --> utils;
  ...
  kyc_controller --> utils;
  logging_controller --> base_controller;
  logging_controller --> messenger;
  logging_controller --> utils;
  ...
  money_account_api_data_service --> utils;
  ...
  money_account_balance_service --> utils;
  ...
  money_account_controller --> utils;
  ...
  money_account_upgrade_controller --> utils;
  money_account_utils --> transaction_controller;
  money_account_utils --> utils;
  ...
  multichain_account_service --> utils;
  ...
  multichain_api_middleware --> utils;
  ...
  multichain_network_controller --> utils;
  ...
  network_connection_banner_controller --> utils;
  ...
  network_enablement_controller --> utils;
  ...
  rate_limit_controller --> utils;
  react_data_query --> base_data_service;
  react_data_query --> utils;
  ...
  remote_feature_flag_controller --> utils;
  ...
  transaction_pay_controller --> utils;
  ...
  user_operation_controller --> utils;

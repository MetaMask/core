...
# Don't modify this file directly; instead, modify \`codeowners.ts\`
# and re-run \`yarn codeowners:generate\`.

# Lines starting with '#' are comments.
# Each line is a file pattern followed by one or more owners.

# Please keep this synchronized with the \`teams.json\` file in the repository root.

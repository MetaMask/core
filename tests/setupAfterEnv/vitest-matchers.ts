...
expect.extend({
   ...
   * (which is the default time that tests wait before timing out as
   * configured in the test configuration file).
   *
   ...
   * amount of time (which is the default time that tests wait before
   * timing out as configured in the test configuration file).
   *
   * Inspired by <https://stackoverflow.com/a/68409467/260771>.
   *
   * @param promise - The promise to test.

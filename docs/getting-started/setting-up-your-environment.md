...
3. Run `yarn install` to install dependencies and run any required post-install scripts. This also installs [MetaMask agent skills](https://github.com/MetaMask/skills).

...
module.exports = (test, testLabel, BaseBlockTracker) => {
  test(`${testLabel} - autostart`, (t) => {
    ...
    t.equal(
      ...
      false,
      'block tracker is stopped after creation',
    );
    ...
    t.equal(
      blockTracker.isRunning(),
      false,
      'block tracker is not started by unrelated event',
    );
    ...
    t.equal(
      blockTracker.isRunning(),
      false,
      'block tracker is not started by removed "block" event',
    );
    ...
    t.equal(
      blockTracker.isRunning(),
      true,
      'block tracker is started by "latest" event',
    );
    ...
    t.equal(
      blockTracker.isRunning(),
      false,
      'block tracker stops after all handlers are removed',
    );
  ...
  test(`${testLabel} - block staleness`, async (t) => {
    ...
    try {
      ...
      t.notOk(
        ...
        'block tracker has no current block',
      );
      ...
      t.equal(
        blockTracker.isRunning(),
        false,
        'block tracker is still stopped',
      );
